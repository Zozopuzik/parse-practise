! function(e) {
    ...
    function k(e, t, i, n = !1) {
        if (t || r.a.error("Cannot call on() with no event: ", t), i || r.a.error("Cannot call on() with no task: ", i), "string" == typeof e) {
            ...
            if (n.length > 0)
                for (let e = 0; e < n.length; e++) k(n[e], t, i)
        } else if (s = e, "[object Array]" === Object.prototype.toString.call(s))
    ...
    function U(e) {
        const t = document.querySelector(e);
        return t || (r.a.debug(`No instance of ${e} found. Returning stub.`), document.createElement("div"))
    }
    ...
    class m {
        ...
        static getIntegration(e) {
            return Object(n.a)(this, void 0, void 0, function*() {
                ...
                if (t) return i ? e ? c.a.SecureProxy : c.a.Secure : !d.b.isLocalhostAllowedAsSecureOrigin() || "localhost" !== location.hostname && "127.0.0.1" !== location.hostname ? c.a.InsecureProxy : c.a.Secure;
                if (i) {
    ...
    n = function() {
        ...
        function t(t) {
            ...
            }, !n.msedge && /(apple)?webkit/i.test(t) ? (/(apple)?webkit\/537\.36/i.test(t) ? (n.name = n.name || "Blink", n.blink = e) : (n.name = n.name || "Webkit", n.webkit = e), !n.version && O && (n.version = O)) : !n.opera && /gecko\//i.test(t) && (n.name = n.name || "Gecko", n.gecko = e, n.version = n.version || i(/gecko\/(\d+(\.\d+)?)/i)), n.windowsphone || n.msedge || !a && !n.silk ? n.windowsphone || n.msedge || !r ? f ? n.mac = e : E ? n.xbox = e : b ? n.windows = e : S && (n.linux = e) : (n[r] = e, n.ios = e) : n.android = e;
            var I = "";
            ...
            return y || l || "ipad" == r || a && (3 == P || P >= 4 && !w) || n.silk ? n.tablet = e : (w || "iphone" == r || "ipod" == r || a || c || n.blackberry || n.webos || n.bada) && (n.mobile = e), n.msedge || n.msie && n.version >= 10 || n.yandexbrowser && n.version >= 15 || n.vivaldi && n.version >= 1 || n.chrome && n.version >= 20 || n.samsungBrowser && n.version >= 4 || n.firefox && n.version >= 20 || n.safari && n.version >= 6 || n.opera && n.version >= 10 || n.ios && n.osversion && n.osversion.split(".")[0] >= 6 || n.blackberry && n.version >= 10.1 || n.chromium && n.version >= 20 ? n.a = e : n.msie && n.version < 10 || n.chrome && n.version < 20 || n.firefox && n.version < 20 || n.safari && n.version < 6 || n.opera && n.version < 10 || n.ios && n.osversion && n.osversion.split(".")[0] < 6 || n.chromium && n.version < 20 ? n.c = e : n.x = e, n
        }
    ...
    e.exports = function(e, t, o) {
        ...
        return window[c] = function(e) {
                h(), o && o(null, e)
            }, e = (e += (~e.indexOf("?") ? "&" : "?") + l + "=" + u(c)).replace("?&", "?"), (s = document.createElement("script")).src = e, g.parentNode.insertBefore(s, g),
            function() {
                window[c] && h()
            }
    };
    ...
    class s {
        ...
        static processAsES6Stub(e) {
            e.SERVICE_WORKER_PATH && (OneSignal.SERVICE_WORKER_PATH = e.SERVICE_WORKER_PATH), e.currentLogLevel && OneSignal.log.setLevel(e.currentLogLevel), e.SERVICE_WORKER_PARAM && (OneSignal.SERVICE_WORKER_PARAM = e.SERVICE_WORKER_PARAM), e.preExistingArray && s.processAsArray(e.preExistingArray);
    ...
    "undefined" != typeof window && function() {
        if (Object(o.p)(), Object(o.n)() > 1) return n.a.warn("OneSignal: The web push SDK is included more than once. For optimal performance, please include our SDK only once on your page."), void n.a.debug("OneSignal: Exiting from SDK initialization to prevent double-initialization errors. " + `Occurred ${Object(o.n)()} times.`);
        ...
        constructor(e, t) {
            ...
            switch (e) {
                ...
                case o.RedundantPermissionMessage:
                    let s = "";
                    t && t.permissionPromptType && (s = `(${n[t.permissionPromptType]})`), i = `Another permission message ${s} is being displayed.`;
                    break;
            ...
            super(i), this.description = o[e], this.reason = e, Object.setPrototypeOf(this, m.prototype)
        }
    }(a = r || (r = {}))[a.Unknown = 0] = "Unknown", a[a.NoDeviceId = 1] = "NoDeviceId", a[a.NoEmailSet = 2] = "NoEmailSet", a[a.NoSMSSet = 3] = "NoSMSSet", a[a.OptedOut = 4] = "OptedOut";
    class b extends p.a {
        constructor(e) {
            let t;
            switch (e) {
            ...
            super(t), this.reason = r[e], Object.setPrototypeOf(this, b.prototype)
        }
    }(l = c || (c = {}))[l.InvalidAppId = 0] = "InvalidAppId", l[l.AppNotConfiguredForWebPush = 1] = "AppNotConfiguredForWebPush", l[l.MissingSubdomain = 2] = "MissingSubdomain", l[l.WrongSiteUrl = 3] = "WrongSiteUrl", l[l.MultipleInitialization = 4] = "MultipleInitialization", l[l.MissingSafariWebId = 5] = "MissingSafariWebId", l[l.Unknown = 6] = "Unknown";
    class f extends p.a {
        constructor(e, t) {
            let i;
            switch (e) {
            ...
            super(i), this.reason = c[e], Object.setPrototypeOf(this, f.prototype)
        }
    }
    var S = i(7);
    class v {
        static put(e, t) {
            return void 0 === v.store[e] && (v.store[e] = [null, null]), v.store[e].push(t), v.store[e].length == v.LIMIT + 1 && v.store[e].shift(), v.store[e]
        }
        static get(e) {
    ...
    class I {
        ...
        static call(e, t, i, n) {
            if ("GET" === e) {
                if (t.indexOf("players") > -1 && -1 === t.indexOf("app_id=")) return console.error("Calls to player api are not permitted without app_id"), Promise.reject(new O.a(O.b.MissingAppId))
            } else if (t.indexOf("players") > -1 && (!i || !i.app_id)) return console.error("Calls to player api are not permitted without app_id"), Promise.reject(new O.a(O.b.MissingAppId));
            const o = new Headers;
            if (o.append("Origin", y.a.getOrigin()), o.append("SDK-Version", `onesignal/web/${h.a.version()}`), o.append("Content-Type", "application/json;charset=UTF-8"), n)
            ...
            let r;
            return i && (s.body = JSON.stringify(i)), fetch(y.a.getOneSignalApiUrl(void 0, t).toString() + "/" + t, s).then(e => (r = e.status, e.json())).then(e => {
                if (r >= 200 && r < 300) return e;
                if ("no-user-id-error" !== I.identifyError(e)) return Promise.reject(e)
            }).catch(e => (E.a.warn(`Could not complete request to /${t}`, e), Promise.reject(e)))
        }
    ...
    class C {
        static getPlayer(e, t) {
            return w.b.enforceAppId(e), w.b.enforcePlayerId(t), P.get(`players/${t}?app_id=${e}`)
        }
        static updatePlayer(e, t, i) {
            return w.b.enforceAppId(e), w.b.enforcePlayerId(t), P.put(`players/${t}`, Object.assign({
                app_id: e
            }, i))
        }
        static sendNotification(e, t, i, n, o, s, r, a) {
            ...
            return i && (c.headings = i), o && (c.url = o), s && (c.chrome_web_icon = s, c.firefox_icon = s), w.b.trimUndefined(c), P.post("notifications", c)
        }
        static createUser(e) {
    ...
    class j {
        ...
        getReportedNotificationPermission(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (h.a.useSafariLegacyPush()) return j.getSafariNotificationPermission(e);
                if (N.b.isUsingSubscriptionWorkaround()) return yield this.getOneSignalSubdomainNotificationPermission(e); {
    ...
    class ee {
        ...
        initialize() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if ((null === (e = this.config) || void 0 === e ? void 0 : e.enabled) && (yield this.loadSdkStyles()))
                    if (E.a.info("OneSignal: initializing customlink"), (null === (t = this.config) || void 0 === t ? void 0 : t.unsubscribeEnabled) || !ee.isPushEnabled())
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (null === (t = this.config) || void 0 === t ? void 0 : t.text) {
                    if (this.config.text.explanation) {
                        ...
                        t.textContent = this.config.text.explanation, Object(X.a)(t, Q.resetClass), Object(X.a)(t, Q.explanationClass), this.config.size && Object(X.a)(t, this.config.size), ee.isPushEnabled() ? Object(X.a)(t, Q.state.subscribed) : Object(X.a)(t, Q.state.unsubscribed), e.appendChild(t)
                    }
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (null === (t = this.config) || void 0 === t ? void 0 : t.text) {
                    if (this.config.text.subscribe) {
                        ...
                        Object(X.a)(t, Q.resetClass), Object(X.a)(t, Q.subscribeClass), this.config.size && Object(X.a)(t, this.config.size), this.config.style && Object(X.a)(t, this.config.style), ee.isPushEnabled() ? Object(X.a)(t, Q.state.subscribed) : Object(X.a)(t, Q.state.unsubscribed), this.setCustomColors(t), yield this.setTextFromPushStatus(t), t.addEventListener("click", () => Object(d.a)(this, void 0, void 0, function*() {
                            E.a.info("CustomLink: subscribe clicked"), yield this.handleClick(t)
                        })), e.appendChild(t)
                    }
                } else E.a.error("CustomLink: required property 'text' is missing in the config")
            })
        ...
        loadSdkStyles() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return 0 === (yield OneSignal.context.dynamicResourceLoader.loadSdkStylesheet()) || (E.a.debug("Not initializing custom link button because styles failed to load."), !1)
            })
        }
        hideElement(e) {
            Object(X.a)(e, Q.hide)
    ...
    class te {
        ...
        static checkAndTriggerSubscriptionChanged() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const e = yield OneSignal.context.subscriptionManager.getSubscriptionState(), t = yield OneSignal.privateIsPushNotificationsEnabled(), i = yield M.a.getAppState(), {
                    lastKnownPushEnabled: n
                } = i;
                (null === n || t !== n) && (E.a.info("The user's subscription state changed from " + `${null===n?"(not stored)":n} ⟶ ${e.subscribed}`), U.setIsPushNotificationsEnabled(t), i.lastKnownPushEnabled = t, yield M.a.setAppState(i), te.triggerSubscriptionChanged(t))
            })
        }
        ...
        static onSubscriptionChanged_showWelcomeNotification(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (OneSignal.__doNotShowWelcomeNotification) return void E.a.debug("Not showing welcome notification because user has previously subscribed.");
                ...
                o = x.a.decodeHtmlEntities(o), s = x.a.decodeHtmlEntities(s), E.a.debug("Sending welcome notification."), C.sendNotification(n, [i], {
                    en: o
                }, {
                    en: s
                }, a, null, {
                    __isOneSignalWelcomeNotification: !0
                }, void 0), S.a.trigger(OneSignal.EVENTS.WELCOME_NOTIFICATION_SENT, {
                    title: o,
                    message: s,
                    url: a
                })
    ...
    class se {
        ...
        static ensureBackwardsCompatibility(e) {
            se.environmentPolyfill(e), se.postmams(e), e.syncHashedEmail = se.promiseStub
        }
    ...
    class re extends p.a {
        constructor() {
            super("This code is not implemented yet."), Object.setPrototypeOf(this, re.prototype)
        }
    }! function(e) {
    ...
    class ae {
        constructor() {
            ...
            this.browserVersion = isNaN(e) ? -1 : e, this.deviceModel = navigator.platform, this.sdkVersion = h.a.version().toString(), this.deliveryPlatform = this.getDeliveryPlatform()
        }
        getDeliveryPlatform() {
    ...
    class ce extends ae {
        ...
        serialize() {
            ...
            return this.subscription && (e.identifier = h.a.useSafariLegacyPush() ? this.subscription.safariDeviceToken : this.subscription.w3cEndpoint ? this.subscription.w3cEndpoint.toString() : null, e.web_auth = this.subscription.w3cAuth, e.web_p256 = this.subscription.w3cP256dh), e
        }
        static createFromPushSubscription(e, t, i) {
            const n = new ce(t);
            return n.appId = e, n.subscriptionState = t ? ie.Subscribed : ie.NotSubscribed, i && (n.subscriptionState = i), n
        }
        deserialize(e) {
            throw new re
        }
    ...
    var le, de, ue = i(17);
    (de = le || (le = {}))[de.Blocked = 0] = "Blocked", de[de.Dismissed = 1] = "Dismissed", de[de.Default = 2] = "Default";
    ...
    class he {
        ...
        static deserialize(e) {
            ...
            return t.w3cP256dh = e.w3cP256dh, t.w3cAuth = e.w3cAuth, t.existingW3cPushSubscription = void 0, e.existingW3cPushSubscription ? t.existingW3cPushSubscription = he.deserialize(e.existingW3cPushSubscription) : e.existingPushSubscription && (t.existingW3cPushSubscription = he.deserialize(e.existingPushSubscription)), t.safariDeviceToken = e.safariDeviceToken, t.existingSafariDeviceToken = e.existingSafariDeviceToken, t
        }
    }
    var pe, me = i(13);
    ! function(e) {
    ...
    class be {
                ...
                switch (y.a.getWindowEnv()) {
                    ...
                    case oe.a.OneSignalSubscriptionModal:
                        try {
                            ...
                            i = yield t.subscriptionManager.registerSubscription(e), t.pageViewManager.incrementPageViewCount(), yield ue.a.triggerNotificationPermissionChanged(), yield te.checkAndTriggerSubscriptionChanged()
                        } catch (e) {
                            E.a.info(e)
                        }
                        break;
                    case oe.a.OneSignalSubscriptionPopup:
                        ...
                        try {
                            ...
                            if (yield t.permissionManager.updateStoredPermission(), i instanceof ge) switch (i.reason) {
                                case le.Blocked:
                        ...
                        break;
                    default:
                        throw "undefined" != typeof OneSignal && (OneSignal._isRegisteringForPush = !1), new m(o.UnsupportedEnvironment)
                }
        ...
        static getRawPushSubscription(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (e.browserType === pe.Safari) return be.getRawPushSubscriptionForSafari(t);
                if (e.isUsingSubscriptionWorkaround) return be.getRawPushSubscriptionWhenUsingSubscriptionWorkaround();
    ...
    class fe {
        static getCurrentNotificationType() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (e === A.Denied) return N.a.isUsingSubscriptionWorkaround() ? ie.Default : ie.NotSubscribed;
        ...
        static checkAndTriggerNotificationPermissionChanged() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = yield M.a.get("Options", "notificationPermission"), t = yield OneSignal.getNotificationPermission();
                e !== t && (yield ue.a.triggerNotificationPermissionChanged(), yield M.a.put("Options", {
                    key: "notificationPermission",
                    value: t
                }))
            })
        ...
        static createDeviceRecord(e, t = !1) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const n = new ce(i);
                return n.appId = e, n.subscriptionState = yield fe.getCurrentNotificationType(), n
            })
        }
        static getDeviceId() {
            return Object(d.a)(this, void 0, void 0, function*() {
    ...
    class ye {
        constructor(e, t, i) {
            ...
            this.emitter = new Oe.a, this.channel = new MessageChannel, this.messagePort = null, this.isListening = !1, this.isConnected = !1, this.replies = {}
        }
        ...
        listen() {
            E.a.debug("(Postmam) Called listen()."), this.isListening ? E.a.debug("(Postmam) Already listening for Postmam connections.") : h.a.isBrowser() && (this.isListening = !0, E.a.debug("(Postmam) Listening for Postmam connections.", this), window.addEventListener("message", this.onWindowMessagePostmanConnectReceived.bind(this)))
        }
        ...
        onWindowPostMessageReceived(e) {
            ...
            if (i === ye.CONNECTED_MESSAGE) return this.emitter.emit("connect"), void(this.isConnected = !0);
            const s = {
                    id: t,
                    command: i,
                    data: n,
        ...
        onWindowMessagePostmanConnectReceived(e) {
            ...
            if (E.a.debug(`(Postmam) (${t}) Window postmessage for Postman connect received:`, e), this.isSafeOrigin(e.origin)) {
                ...
                i === ye.HANDSHAKE_MESSAGE ? (E.a.info("(Postmam) Got our expected Postmam handshake message (and connecting...):", e.data), window.removeEventListener("message", this.onWindowMessagePostmanConnectReceived), this.messagePort = e.ports[0], this.messagePort.addEventListener("message", this.onMessageReceived.bind(this), !1), E.a.info("(Postmam) Removed previous message event listener for handshakes, replaced with main message listener."), this.messagePort.start(), this.isConnected = !0, E.a.info(`(Postmam) (${t}) Connected.`), this.message(ye.CONNECTED_MESSAGE), this.emitter.emit("connect")) : E.a.info("(Postmam) Got a postmam message, but not our expected handshake:", e.data)
            }
        }
        connect() {
            E.a.info(`(Postmam) (${y.a.getWindowEnv().toString()}) Establishing a connection to ${this.sendToOrigin}.`), this.messagePort = this.channel.port1, this.messagePort.addEventListener("message", this.onMessageReceived.bind(this), !1), this.messagePort.start(), this.windowReference.postMessage({
                handshake: ye.HANDSHAKE_MESSAGE
            }, this.sendToOrigin, [this.channel.port2])
        }
        onMessageReceived(e) {
            if (!e.data) return void E.a.debug(`(${y.a.getWindowEnv().toString()}) Received an empty Postmam message:`, e);
            const {
                id: t,
                command: i,
                data: n,
    ...
    class we {
        ...
        onModalAccepted(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                E.a.debug("User accepted the HTTPS modal prompt.", location.origin), OneSignal._sessionInitAlreadyRunning = !1, this.dispose(), fe.triggerCustomPromptClicked("granted"), E.a.debug("Calling setSubscription(true)"), yield be.registerForPush(), yield OneSignal.setSubscription(!0)
            })
        }
        onModalRejected(e) {
            E.a.debug("User rejected the HTTPS modal prompt."), OneSignal._sessionInitAlreadyRunning = !1, this.dispose(), fe.triggerCustomPromptClicked("denied")
        }
        onModalClosing(e) {
    ...
    class Pe {
        ...
        directPostMessageToSW(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (!i) return void E.a.error("`[Worker Messenger] [Page -> SW] Could not get ServiceWorkerRegistration to postMessage!");
        ...
        listen() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                y.a.getWindowEnv() === oe.a.ServiceWorker ? (self.addEventListener("message", this.onWorkerMessageReceivedFromPage.bind(this)), E.a.debug("[Worker Messenger] Service worker is now listening for messages.")) : yield this.listenForPage()
            })
        }
        listenForPage() {
            return Object(d.a)(this, void 0, void 0, function*() {
                navigator.serviceWorker.addEventListener("message", this.onPageMessageReceivedFromServiceWorker.bind(this)), E.a.debug(`(${location.origin}) [Worker Messenger] Page is now listening for messages.`)
            })
        }
    ...
    class Ce {
        ...
        loadIfNew(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return this.cache[t.toString()] || (this.cache[t.toString()] = Ce.load(e, t)), yield this.cache[t.toString()]
            })
        }
        static load(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
    ...
    class ke {
        ...
        show() {
            return this.hidden ? new Promise(e => {
                ...
                if (t ? (this.hideClass && Object(X.v)(t, this.hideClass), this.showClass && Object(X.a)(t, this.showClass)) : E.a.error(`(show) could not find animated element with selector ${this.selector}`), 0 == this.targetTransitionEvents.length) return e(this);
                var i = setTimeout(() => {
                ...
                Object(X.u)(this.element, "transitionend", (t, n) => {
                    if (t.target === this.element && Object(X.f)(this.targetTransitionEvents, t.propertyName)) return clearTimeout(i), n(), this.state = "shown", S.a.trigger(ke.EVENTS.SHOWN, this), e(this)
                }, !0)
        ...
        hide() {
            return this.shown ? new Promise(e => {
                ...
                const t = this.element;
                if (t ? (this.showClass && Object(X.v)(t, this.showClass), this.hideClass && Object(X.a)(t, this.hideClass)) : E.a.error(`(hide) could not find animated element with selector ${this.selector}`), 0 == this.targetTransitionEvents.length) return e(this);
                Object(X.u)(this.element, "transitionend", (t, i) => {
                    var n = setTimeout(() => {
                        E.a.debug(`Element did not completely hide (state: ${this.state}).`)
                    }, this.transitionCheckTimeout);
                    if (t.target === this.element && Object(X.f)(this.targetTransitionEvents, t.propertyName)) return clearTimeout(n), i(), this.state = "hidden", S.a.trigger(ke.EVENTS.HIDDEN, this), e(this)
                }, !0)
            }) : Promise.resolve(this)
        }
        waitUntilShown() {
    ...
    class je extends ke {
        ...
        activate() {
            return this.inactive && this.shown ? new Promise(e => {
                this.activeState = "activating", S.a.trigger(je.EVENTS.ACTIVATING, this);
                const t = this.element;
                if (t ? (this.inactiveClass && Object(X.v)(t, this.inactiveClass), this.activeClass && Object(X.a)(t, this.activeClass)) : E.a.error("Could not find active animated element"), !this.shown) return E.a.debug("Ending activate() transition (alternative)."), this.activeState = "active", S.a.trigger(je.EVENTS.ACTIVE, this), e(this);
                ...
                Object(X.u)(this.element, "transitionend", (t, n) => {
                    if (t.target === this.element && Object(X.f)(this.targetTransitionEvents, t.propertyName)) return clearTimeout(i), n(), this.activeState = "active", S.a.trigger(je.EVENTS.ACTIVE, this), e(this)
                }, !0)
            }) : Promise.resolve(this)
        }
        inactivate() {
            return this.active ? new Promise(e => {
                this.activeState = "inactivating", S.a.trigger(je.EVENTS.INACTIVATING, this);
                const t = this.element;
                if (t ? (this.activeClass && Object(X.v)(t, this.activeClass), this.inactiveClass && Object(X.a)(t, this.inactiveClass)) : E.a.error("Could not find active animated element"), !this.shown) return this.activeState = "inactive", S.a.trigger(je.EVENTS.INACTIVE, this), e(this);
                if (0 == this.targetTransitionEvents.length) return e(this);
                var i = setTimeout(() => {
                    E.a.debug(`Element did not completely inactivate (state: ${this.state}, activeState: ${this.activeState}).`)
                }, this.transitionCheckTimeout);
                Object(X.u)(this.element, "transitionend", (t, n) => {
                    if (t.target === this.element && Object(X.f)(this.targetTransitionEvents, t.propertyName)) return clearTimeout(i), n(), this.activeState = "inactive", S.a.trigger(je.EVENTS.INACTIVE, this), e(this)
                }, !0)
            }) : Promise.resolve(this)
        }
        waitUntilActive() {
    ...
    class De extends ke {
        ...
        display(e, t, i = 0) {
            return E.a.debug(`Calling %cdisplay(${e}, ${t}, ${i}).`, Object(X.k)("code")), (this.shown ? this.hide() : Object(X.t)()).then(() => {
        ...
        enqueue(e) {
            return this.queued.push(Object(X.g)(e)), new Promise(e => {
    ...
    class Re extends je {
        ...
        onHovering() {
            (v.isEmpty(this.events.mouse) || "out" === v.getLast(this.events.mouse)) && S.a.trigger(Ke.EVENTS.HOVERING), v.put(this.events.mouse, "over")
        }
        onHovered() {
        ...
        onClick() {
            if (S.a.trigger(Ke.EVENTS.BELL_CLICK), S.a.trigger(Ke.EVENTS.LAUNCHER_CLICK), !this.bell.message.shown || this.bell.message.contentType != De.TYPES.MESSAGE) {
                ...
                }) : (Bi.registerForPushNotifications(), this.bell._ignoreSubscriptionState = !0, Bi.emitter.once(Bi.EVENTS.SUBSCRIPTION_CHANGED, () => {
        ...
        pulse() {
            Object(X.w)(".pulse-ring"), this.element && Object(X.b)(this.element, "beforeend", '<div class="pulse-ring"></div>'), this.bell.setCustomColorsIfSpecified()
        }
    }
    class Ue extends ke {
        constructor(e) {
        ...
        updateBellLauncherDialogBody() {
            return OneSignal.getSubscription().then(e => {
                ...
                var i = "";
                if (this.bell.options.showCredit && (i = '<div class="divider"></div><div class="kickback">Powered by <a href="https://onesignal.com" class="kickback" target="_blank">OneSignal</a></div>'), this.bell.state === Ke.STATES.SUBSCRIBED && !0 === e || this.bell.state === Ke.STATES.UNSUBSCRIBED && !1 === e) {
                    let e = "";
                    ...
                    let n = "";
                    e && (n = `<a href="${e=y.a.getOneSignalStaticResourcesUrl()+e}" target="_blank"><img src="${e}"></a></div>`), (g.a.mobile || g.a.tablet) && g.a.chrome && (n = "<ol><li>Access <strong>Settings</strong> by tapping the three menu dots <strong>⋮</strong></li><li>Click <strong>Site settings</strong> under Advanced.</li><li>Click <strong>Notifications</strong>.</li><li>Find and click this entry for this website.</li><li>Click <strong>Notifications</strong> and set it to <strong>Allow</strong>.</li></ol>"), t = `<h1>${this.bell.options.text["dialog.blocked.title"]}</h1><div class="divider"></div><div class="instructions"><p>${this.bell.options.text["dialog.blocked.message"]}</p>${n}</div>${i}`
                }
                this.nestedContentSelector && Object(X.b)(this.nestedContentSelector, "beforeend", t), this.subscribeButton && this.subscribeButton.addEventListener("click", () => {
                    OneSignal.__doNotShowWelcomeNotification = !1, S.a.trigger(Ke.EVENTS.SUBSCRIBE_CLICK)
                }), this.unsubscribeButton && this.unsubscribeButton.addEventListener("click", () => S.a.trigger(Ke.EVENTS.UNSUBSCRIBE_CLICK)), this.bell.setCustomColorsIfSpecified()
            })
        }
    }
    class We extends je {
        ...
        resize(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if ("small" === e && Object(X.o)(this.element, "onesignal-bell-launcher-sm") || "medium" === e && Object(X.o)(this.element, "onesignal-bell-launcher-md") || "large" === e && Object(X.o)(this.element, "onesignal-bell-launcher-lg")) return Promise.resolve(this);
                if (Object(X.v)(this.element, "onesignal-bell-launcher-sm"), Object(X.v)(this.element, "onesignal-bell-launcher-md"), Object(X.v)(this.element, "onesignal-bell-launcher-lg"), "small" === e) Object(X.a)(this.element, "onesignal-bell-launcher-sm");
                else if ("medium" === e) Object(X.a)(this.element, "onesignal-bell-launcher-md");
                else {
                ...
                return this.shown ? yield new Promise(e => {
                    ...
                    Object(X.u)(this.element, "transitionend", (i, n) => {
                        if (i.target === this.element && Object(X.f)(this.targetTransitionEvents, i.propertyName)) return clearTimeout(t), n(), e(this)
                    }, !0)
                }): this
            })
        }
        activateIfInactive() {
            return this.inactive ? (this.wasInactive = !0, this.activate()) : Object(X.t)()
        }
        inactivateIfWasInactive() {
            return this.wasInactive ? (this.wasInactive = !1, this.inactivate()) : Object(X.t)()
        }
        clearIfWasInactive() {
            this.wasInactive = !1
        }
    ...
    function(e) {
        e.PromptDismissCount = "promptDismissCount", e.NonPushPromptsDismissCount = "nonPushPromptsDismissCount"
    }(Ae || (Ae = {})),
    function(e) {
        e.OneSignalNotificationPrompt = "onesignal-notification-prompt", e.OneSignalNonPushPrompt = "onesignal-non-push-prompt"
    }(Me || (Me = {}));
    const Le = {
    ...
    class Fe {
        static markPromptDismissedWithType(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                let o = 3;
                2 == n ? o = 7 : n > 2 && (o = 30), E.a.debug(`(${y.a.getWindowEnv().toString()}) OneSignal: User dismissed the ${e} ` + `notification prompt; reprompt after ${o} days.`), yield M.a.put("Options", {
                    key: t,
                    value: n
                });
                const s = 24 * o * 60;
    ...
    class Ke {
        constructor(e, t) {
            this.state = Ke.STATES.UNINITIALIZED, this._ignoreSubscriptionState = !1, this.hovering = !1, this.initialized = !1, this.DEFAULT_SIZE = "medium", this.DEFAULT_POSITION = "bottom-right", this.DEFAULT_THEME = "default", this.options = {
                enable: e.enable || !1,
                ...
                colors: e.colors,
                offset: e.offset
            }, t && (this._launcher = t), this.options.enable && (this.validateOptions(this.options), this.state = Ke.STATES.UNINITIALIZED, this._ignoreSubscriptionState = !1, this.installEventHooks(), this.updateState())
        }
        static get EVENTS() {
            return {
        ...
        validateOptions(e) {
            if (!e.size || !Object(X.f)(["small", "medium", "large"], e.size)) throw new Error(`Invalid size ${e.size} for notify button. Choose among 'small', 'medium', or 'large'.`);
            if (!e.position || !Object(X.f)(["bottom-left", "bottom-right"], e.position)) throw new Error(`Invalid position ${e.position} for notify button. Choose either 'bottom-left', or 'bottom-right'.`);
            if (!e.theme || !Object(X.f)(["default", "inverse"], e.theme)) throw new Error(`Invalid theme ${e.theme} for notify button. Choose either 'default', or 'inverse'.`);
        ...
        installEventHooks() {
            Bi.emitter.on(Ke.EVENTS.SUBSCRIBE_CLICK, () => {
                ...
                this.hovering = !0, this.launcher.activateIfInactive(), this.message.shown || this.dialog.shown ? this.hovering = !1 : this.message.contentType !== De.TYPES.MESSAGE ? new Promise(e => {
                    ...
                    this.message.content = Object(X.g)(this.message.getTipForState()), this.message.contentType = De.TYPES.TIP, e()
                }).then(() => this.message.show()).then(() => {
                    this.hovering = !1
                }) : this.hovering = !1
            }), Bi.emitter.on(Ke.EVENTS.HOVERED, () => {
                this.message.contentType !== De.TYPES.MESSAGE && this.dialog.hidden && (this.hovering && (this.hovering = !1, this.message.waitUntilShown().then(() => Object(X.i)(De.TIMEOUT)).then(() => this.message.hide()).then(() => {
                ...
                Bi.getNotificationPermission(t => {
                    let i;
                    i = e ? Ke.STATES.SUBSCRIBED : t === A.Denied ? Ke.STATES.BLOCKED : Ke.STATES.UNSUBSCRIBED, this.setState(i, this._ignoreSubscriptionState)
                })
        ...
        addDefaultClasses() {
            ...
            if ("bottom-left" === this.options.position) e && Object(X.a)(e, "onesignal-bell-container-bottom-left"), Object(X.a)(this.launcher.selector, "onesignal-bell-launcher-bottom-left");
            else {
                if ("bottom-right" !== this.options.position) throw new Error("Invalid OneSignal notify button position " + this.options.position);
                e && Object(X.a)(e, "onesignal-bell-container-bottom-right"), Object(X.a)(this.launcher.selector, "onesignal-bell-launcher-bottom-right")
            }
            if ("default" === this.options.theme) Object(X.a)(this.launcher.selector, "onesignal-bell-launcher-theme-default");
            else {
        ...
        create() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (0 !== (yield Bi.context.dynamicResourceLoader.loadSdkStylesheet())) return void E.a.debug("Not showing notify button because styles failed to load.");
                this.container && Object(X.w)("#onesignal-bell-container"), Object(X.b)("body", "beforeend", '<div id="onesignal-bell-container" class="onesignal-bell-container onesignal-reset"></div>'), this.container && Object(X.b)(this.container, "beforeend", '<div id="onesignal-bell-launcher" class="onesignal-bell-launcher"></div>'), Object(X.b)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-button"></div>'), Object(X.b)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-badge"></div>'), Object(X.b)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-message"></div>'), Object(X.b)(this.message.selector, "beforeend", '<div class="onesignal-bell-launcher-message-body"></div>'), Object(X.b)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-dialog"></div>'), Object(X.b)(this.dialog.selector, "beforeend", '<div class="onesignal-bell-launcher-dialog-body"></div>'), Object(X.b)(this.button.selector, "beforeend", qe);
                const e = yield Bi.isPushNotificationsEnabled(), t = yield Bi.getSubscription(), i = Fe.wasPromptOfTypeDismissed(Te.Push), n = e ? "small" : this.options.size || this.DEFAULT_SIZE;
                yield this.launcher.resize(n), this.addDefaultClasses(), this.applyOffsetIfSpecified(), this.setCustomColorsIfSpecified(), this.patchSafariSvgFilterBug(), E.a.info("Showing the notify button."), yield(e ? this.launcher.inactivate() : Object(X.t)()).then(() => Bi.getSubscription()).then(t => !e && t || null !== this.dialog.notificationIcons ? Object(X.t)() : fe.getNotificationIcons().then(e => {
                    this.dialog.notificationIcons = e
                })).then(() => Object(X.i)(this.options.showLauncherAfter || 0)).then(() => Object(X.q)() && t && !0 !== i && !e && !0 === Bi.config.userConfig.promptOptions.autoPrompt && !fe.isHttpPromptAlreadyShown() ? (E.a.debug("Not showing notify button because slidedown will be shown."), Object(X.t)()) : this.launcher.show()).then(() => Object(X.i)(this.options.showBadgeAfter || 0)).then(() => this.options.prenotify && !e && Bi._isNewVisitor ? this.message.enqueue(this.options.text["message.prenotify"]).then(() => this.badge.show()) : Object(X.t)()).then(() => this.initialized = !0)
            })
        }
        ...
        updateState() {
            Promise.all([Bi.privateIsPushNotificationsEnabled(), Bi.privateGetNotificationPermission()]).then(([e, t]) => {
                this.setState(e ? Ke.STATES.SUBSCRIBED : Ke.STATES.UNSUBSCRIBED), t === A.Denied && this.setState(Ke.STATES.BLOCKED)
            })
        }
        setState(e, t = !1) {
            const i = this.state;
            this.state = e, i === e || t || S.a.trigger(Ke.EVENTS.STATE_CHANGED, {
                from: i,
                to: e
            })
        }
        ...
        get launcher() {
            return this._launcher || (this._launcher = new We(this)), this._launcher
        }
        get button() {
    ...
    class Ye {
        ...
        openWindowViaPost(e, t, i) {
            ...
            if (t)
                for (var h in t) {
                    ...
                    p.name = h, p.value = "object" == typeof t[h] ? JSON.stringify(t[h]) : t[h], n.appendChild(p)
                }
        ...
        onBeginMessagePortCommunications(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return E.a.debug(`(${y.a.getWindowEnv().toString()}) Successfully established cross-origin messaging with the popup window.`), this.messenger.connect(), !1
            })
        }
        onPopupLoaded(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
        ...
        onPopupClosing(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                E.a.info("Popup window is closing, running cleanup events."), S.a.trigger(OneSignal.EVENTS.POPUP_CLOSING), this.dispose()
            })
        }
        onSetSessionCount(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
        ...
        onWindowTimeout(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                E.a.debug(y.a.getWindowEnv().toString() + " Popup window timed out and was closed."), S.a.trigger(OneSignal.EVENTS.POPUP_WINDOW_TIMEOUT)
            })
        }
        onFinishingRegistrationRemotely(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                E.a.debug(location.origin, y.a.getWindowEnv().toString() + " Finishing HTTP popup registration inside the iFrame, sent from popup."), e.reply({
                    progress: !0
                });
                const {
                    rawPushSubscription: t
                } = e.data;
                this.messenger && this.messenger.stopPostMessageReceive(), yield OneSignal.context.subscriptionManager.registerSubscription(t), yield te.checkAndTriggerSubscriptionChanged(), yield fe.checkAndTriggerNotificationPermissionChanged()
            })
        }
    ...
    class Ze {}($e = He || (He = {})).HttpPermissionRequest = "HttpPermissionRequest", $e.SyncHashedEmail = "SyncHashedEmail";
    class Xe extends Qe {
        constructor(e) {
    ...
    }(ze = Ge || (Ge = {}))[ze.HttpPermissionRequest = 0] = "HttpPermissionRequest", ze[ze.SyncHashedEmail = 1] = "SyncHashedEmail";
    class it extends p.a {
        constructor(e) {
            let t, i;
            switch (e) {
                case Ge.HttpPermissionRequest:
                    t = "The HTTP permission request has been deprecated. Please remove any custom popups from your code.", i = He.HttpPermissionRequest;
                    break;
                case Ge.SyncHashedEmail:
                    t = "API syncHashedEmail() has been deprecated and will be removed in a future SDK release. Please remove any usages from your code.", i = He.SyncHashedEmail
            }
            super(t), this.reportUsage(i), Object.setPrototypeOf(this, it.prototype)
        }
        reportUsage(e) {
    ...
    class nt {
        static internalInit() {
            return Object(d.a)(this, void 0, void 0, function*() {
                E.a.debug("Called %cinternalInit()", Object(X.k)("code")), yield OneSignal.context.serviceWorkerManager.installWorker();
                const e = OneSignal.context.sessionManager;
                OneSignal.emitter.on(OneSignal.EVENTS.SESSION_STARTED, e.sendOnSessionUpdateFromPage.bind(e)), OneSignal.context.pageViewManager.incrementPageViewCount(), "visible" === document.visibilityState ? yield nt.sessionInit(): nt.postponeSessionInitUntilPageIsInFocus()
            })
        }
        ...
        static sessionInit() {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (E.a.debug("Called %csessionInit()", Object(X.k)("code")), OneSignal._sessionInitAlreadyRunning) return void E.a.debug("Returning from sessionInit because it has already been called.");
                ...
                U.setIsOptedOut(!!e), N.a.isUsingSubscriptionWorkaround() || (yield nt.handleAutoResubscribe(e));
                const t = yield OneSignal.privateIsPushNotificationsEnabled();
                U.setIsPushNotificationsEnabled(!!t), OneSignal.config.userConfig.promptOptions.autoPrompt && !e && OneSignal.context.promptsManager.spawnAutoPrompts(), OneSignal._sessionInitAlreadyRunning = !1, yield S.a.trigger(OneSignal.EVENTS.SDK_INITIALIZED)
            })
        }
        static registerForPushNotifications(e = {}) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (e && e.modalPrompt) return OneSignal.subscriptionModalHost = new we(OneSignal.config.appId, e), void(yield OneSignal.subscriptionModalHost.load());
                if (N.a.isUsingSubscriptionWorkaround()) return e.httpPermissionRequest ? void E.a.error(new it(Ge.HttpPermissionRequest)) : void(yield nt.loadSubscriptionPopup(e));
        ...
        static loadSubscriptionPopup(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                OneSignal.subscriptionPopupHost = new Ye(OneSignal.proxyFrameHost.url, e), yield OneSignal.subscriptionPopupHost.load()
            })
        }
        static storeInitialValues() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                v.put("subscription.optedOut", i), yield M.a.put("Options", {
                    key: "isPushEnabled",
                    value: e
        ...
        static establishServiceWorkerChannel() {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (navigator.serviceWorker && "https:" === window.location.protocol && !(yield y.a.isFrameContextInsecure())) try {
        ...
        static processExpiringSubscriptions() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const t = yield y.a.getIntegration(), i = y.a.getWindowEnv();
                switch (E.a.debug("Subscription is considered expiring. Current Integration:", t), t) {
                    ...
                    case Ne.a.SecureProxy:
                        if (i === oe.a.OneSignalProxyFrame) yield this.registerSubscriptionInProxyFrame(e);
                        else {
                    ...
                    case Ne.a.InsecureProxy:
                        yield M.a.remove("Ids", "registrationId"), E.a.debug("Unsubscribed expiring HTTP subscription by removing registration ID.")
                }
                return !0
            })
        }
        ...
        static doInitialize() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = [];
                e.push(nt.storeInitialValues()), e.push(nt.installNativePromptPermissionChangedHook()), e.push(nt.setWelcomeNotificationFlag()), e.push(nt.establishServiceWorkerChannel()), e.push(nt.showNotifyButton()), e.push(nt.showPromptsFromWebConfigEditor());
                try {
                    yield Promise.all(e)
                } catch (e) {
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                if (h.a.isBrowser() && !OneSignal.notifyButton) {
                    ...
                    e && "function" == typeof e ? OneSignal.emitter.once(OneSignal.EVENTS.SDK_INITIALIZED, () => Object(d.a)(this, void 0, void 0, function*() {
                        !1 !== (yield Promise.resolve(OneSignal.config.userConfig.notifyButton.displayPredicate())) ? (OneSignal.notifyButton = new Ke(OneSignal.config.userConfig.notifyButton), OneSignal.notifyButton.create()) : E.a.debug("Notify button display predicate returned false so not showing the notify button.")
                    })) : (OneSignal.notifyButton = new Ke(OneSignal.config.userConfig.notifyButton), OneSignal.notifyButton.create())
                }
            })
        }
        ...
        static initSaveState(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = yield fe.getAppId(), i = OneSignal.config;
                yield M.a.put("Ids", {
                    type: "appId",
                    id: t
                });
        ...
        static polyfillSafariFetch() {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (g.a.safari && void 0 === window.fetch) {
                    ...
                    try {
                        yield(new Ce).loadFetchPolyfill(), E.a.debug("Done loading fetch polyfill.")
                    } catch (e) {
    ...
    class ot {
        ...
        setPageViewCount(e) {
            try {
                sessionStorage.setItem(ot.SESSION_STORAGE_KEY_NAME, e.toString()), y.a.getWindowEnv() === oe.a.OneSignalSubscriptionPopup && OneSignal.subscriptionPopup && OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.SET_SESSION_COUNT)
            } catch (e) {}
        }
    ...
    class rt extends p.a {
        constructor(e, t) {
            super("Registration of a Service Worker failed."), this.status = e, this.statusText = t, Object.setPrototypeOf(this, rt.prototype)
        }
    }
    var at, ct = rt;
    ! function(e) {
    ...
    class lt {
        static downloadServerAppConfig(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return w.a.enforceAppId(e), yield new Promise((t, i) => {
                    t(I.get(`sync/${e}/web`, null))
                })
            })
        }
        static getUserIdFromSubscriptionIdentifier(e, t, i) {
            return w.a.enforceAppId(e), I.post("players", {
                app_id: e,
                device_type: t,
                identifier: i,
                notification_types: ie.TemporaryWebRecord
            }).then(e => e && e.id ? e.id : null).catch(e => (E.a.debug("Error getting user ID from subscription identifier:", e), null))
        }
        static updatePlayer(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
    ...
    class pt {
        ...
        beforeOutcomeSend() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                return Object(X.s)(e, this.outcomeName), this.config ? this.outcomeName ? (yield Object(X.c)(), !!(yield OneSignal.privateIsPushNotificationsEnabled()) || (E.a.warn("Reporting outcomes is supported only for subscribed users."), !1)) : (E.a.error("Outcome name is required"), !1) : (E.a.debug("Outcomes feature not supported by main application yet."), !1)
            })
        }
        ...
        saveSentUniqueOutcome(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = this.outcomeName,
                    i = yield M.a.get("SentUniqueOutcome", t), n = yield M.a.getCurrentSession(), o = [...i ? i.notificationIds : [], ...e], s = n ? n.startTimestamp : null;
        ...
        wasSentDuringSession() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (!e) return !1;
                const t = yield M.a.getCurrentSession(), i = t && e.sentDuringSession === t.startTimestamp, n = !t && !!e.sentDuringSession;
                return i || n
            })
        }
        send(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                switch (t) {
                    ...
                    case at.Unattributed:
                        if (this.isUnique) {
                            if (yield this.wasSentDuringSession()) return void E.a.warn("(Unattributed) unique outcome was already sent during this session");
        ...
        static getAttribution(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (e.indirect && e.indirect.enabled) {
                    ...
                    if (E.a.debug(`\tFound total of ${n.length} received notifications`), n.length > 0) {
                        ...
                        if (r.forEach(e => M.a.remove("NotificationReceived", e)), E.a.debug(`\t${r.length} received notifications will be deleted.`), s.length > 0) return {
                            type: at.Indirect,
                            notificationIds: s
                        }
                    }
    ...
    class wt {
        ...
        logout() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                return (yield yt.logoutEmail(i, e, t)) ? (yield M.a.setEmailProfile(new St.a), !0) : (E.a.warn("Failed to logout email."), !1)
            })
        }
        setIdentifier(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
        ...
        updatePushPlayersRelationToEmailPlayer(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const {
                    deviceId: i
                } = yield M.a.getSubscription(), n = i, o = !!!e.subscriptionId || e.subscriptionId !== t.subscriptionId, s = !e.identifier || t.identifier !== e.identifier;
                if (i && n && (o || s)) {
                    const e = yield OneSignal.database.getExternalUserIdAuthHash(), n = yield M.a.getAppConfig();
    ...
    class Pt {
        ...
        setIdentifier(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const i = yield M.a.getAppConfig(), n = yield this.profileProvider.getProfile(), o = this.profileProvider.newProfile(n.subscriptionId, e, t);
                if (n.subscriptionId) yield yt.updatePlayer(i.appId, n.subscriptionId, {
                    identifier: e,
                    ...
                    const {
                        deviceId: e
                    } = yield M.a.getSubscription(), t = new It(this.profileProvider.deviceType, o.identifier, o.identifierAuthHash, e);
                    t.appId = i.appId, yield Et.addExternalUserIdToDeviceRecord(t), o.subscriptionId = yield yt.createUser(t)
                }
        ...
        sendTags(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = yield this.profileProvider.getSubscriptionId(), {
                    appId: i
                } = yield M.a.getAppConfig(), n = (yield this.profileProvider.getProfile()).identifierAuthHash, o = {
                    tags: e,
    ...
    class Wt {
        ...
        logout() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return (yield M.a.getSMSProfile()).subscriptionId ? (yield M.a.setSMSProfile(new Rt.a), !0) : (E.a.warn(new b(r.NoSMSSet)), !1)
            })
        }
        setIdentifier(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
    ...
    class Lt {
        ...
        static appendServiceWorkerParams(e, t, i) {
            return `${new URL(e,N.a.getBaseUrl()).href}?${w.b.encodeHashAsUriComponent({appId:t})}&${w.b.encodeHashAsUriComponent({sdkVersion:i})}`
        }
        static upsertSession(e, t, i, n, o, s) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (!n) return void ut.error("No deviceId provided for new session.");
                if (!i.app_id) return void ut.error("No appId provided for new session.");
                ...
                if (!r) {
                    ...
                    return s && (t.notificationId = s.notificationId), yield M.a.upsertSession(t), void(yield Lt.sendOnSessionCallIfNecessary(o, i, n, t))
                }
                if (r.status === me.c.Active) return void ut.debug("Session already active", r);
                if (!r.lastDeactivatedTimestamp) return void ut.debug("Session is in invalid state", r);
                const a = (new Date).getTime();
                if (Lt.timeInSecondsBetweenTimestamps(a, r.lastDeactivatedTimestamp) <= e) return r.status = me.c.Active, r.lastActivatedTimestamp = a, r.lastDeactivatedTimestamp = null, void(yield M.a.upsertSession(r));
                ...
                yield M.a.upsertSession(c), yield Lt.sendOnSessionCallIfNecessary(o, i, n, c)
            })
        }
        static deactivateSession(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const n = yield M.a.getCurrentSession();
                if (!n) return void ut.debug("No active session found. Cannot deactivate.");
                if (n.status === me.c.Inactive) return bt(() => Lt.finalizeSession(n, t, i), e);
                if (n.status !== me.c.Active) return void ut.warn(`Session in invalid state ${n.status}. Cannot deactivate.`);
                const o = (new Date).getTime(),
                    s = Lt.timeInSecondsBetweenTimestamps(o, n.lastActivatedTimestamp);
                n.lastDeactivatedTimestamp = o, n.accumulatedDuration += s, n.status = me.c.Inactive;
        ...
        static sendOnSessionCallIfNecessary(e, t, i, n) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                o !== i && (n.deviceId = o, yield Promise.all([M.a.setDeviceId(o), M.a.upsertSession(n), M.a.resetSentUniqueOutcomes()])), yield(new Bt).synchronizer.onSession()
            })
        }
        static finalizeSession(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (ut.debug("Finalize session", `started: ${new Date(e.startTimestamp)}`, `duration: ${e.accumulatedDuration}s`), t) {
                    ut.debug(`send on_focus reporting session duration -> ${e.accumulatedDuration}s`);
                    const t = yield pt.getAttribution(i);
                    ut.debug("send on_focus with attribution", t), yield lt.sendSessionDuration(e.appId, e.deviceId, e.accumulatedDuration, e.deviceType, t), yield(new Bt).synchronizer.onFocus(e.accumulatedDuration)
                }
                yield Promise.all([M.a.cleanupCurrentSession(), M.a.removeAllNotificationClicked()]), ut.debug("Finalize session finished", `started: ${new Date(e.startTimestamp)}`)
            })
        }
        static timeInSecondsBetweenTimestamps(e, t) {
            return e <= t ? 0 : Math.floor((e - t) / 1e3)
        }
    }(jt = kt || (kt = {})).OneSignalWorker = "OneSignal Worker", jt.ThirdParty = "3rd Party", jt.None = "None", jt.Indeterminate = "Indeterminate";
    class Vt {
        constructor(e, t) {
        ...
        static activeSwFileName(e) {
            ...
            if ("akam-sw.js" == n) {
                ...
                if (e) return E.a.debug("Found a ServiceWorker under Akamai's akam-sw.js?othersw=", e), new st(new URL(e).pathname).getFileName()
            }
            return n
        }
        ...
        getWorkerVersion() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return new Promise(e => Object(d.a)(this, void 0, void 0, function*() {
                    ...
                    } else this.context.workerMessenger.once(Se.WorkerVersion, t => {
                        e(t)
        ...
        shouldInstallWorker() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (OneSignal.config.subdomain && "safari" !== OneSignal.environmentInfo.browserType && y.a.getWindowEnv() === oe.a.Host) return !1;
                const e = yield this.getActiveState();
                if (E.a.debug("[shouldInstallWorker] workerState", e), e === kt.None || e === kt.ThirdParty) {
                    const e = "granted" === (yield OneSignal.context.permissionManager.getNotificationPermission(OneSignal.config.safariWebId));
                    return e && E.a.info("[shouldInstallWorker] Notification Permissions enabled, will install ServiceWorker"), e
                }
        ...
        haveParamsChanged() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (!e) return E.a.info("[changedServiceWorkerParams] workerRegistration not found at scope", this.config.registrationOptions.scope), !0;
                const t = new URL(e.scope).pathname,
                    i = this.config.registrationOptions.scope;
                if (t != i) return E.a.info("[changedServiceWorkerParams] ServiceWorker scope changing", {
                    a_old: t,
                    b_new: i
                }), !0;
        ...
        workerNeedsUpdate() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                return e !== h.a.version() ? (E.a.info(`[Service Worker Update] Updating service worker from ${e} --\x3e ${h.a.version()}.`), !0) : (E.a.info(`[Service Worker Update] Service worker version is current at ${e} (no update required).`), !1)
            })
        }
        establishServiceWorkerChannel() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                e.off(), e.on(Se.NotificationDisplayed, e => Object(d.a)(this, void 0, void 0, function*() {
                    E.a.debug(location.origin, "Received notification display event from service worker."), yield S.a.trigger(OneSignal.EVENTS.NOTIFICATION_DISPLAYED, e)
                    ...
                    if (0 === (t = y.a.getWindowEnv() === oe.a.OneSignalProxyFrame ? yield new Promise(e => {
                        ...
                        let t = e.url;
                        e.url || (t = location.href), yield M.a.put("NotificationOpened", {
                            url: t,
                            data: e,
                            timestamp: Date.now()
                        })
        ...
        installWorker() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                E.a.info("Installing worker..."), (yield this.getActiveState()) === kt.ThirdParty && E.a.info("[Service Worker Installation] 3rd party service worker detected.");
                ...
                try {
                    ...
                    if (E.a.error(`[Service Worker Installation] Installing service worker failed ${t}`), y.a.getWindowEnv() === oe.a.OneSignalSubscriptionPopup) throw t;
                    const i = yield fetch(e);
                    if (403 === i.status || 404 === i.status) throw new ct(i.status, i.statusText);
                    throw t
                }
                E.a.debug("[Service Worker Installation] Service worker installed."), yield this.establishServiceWorkerChannel()
            })
        }
    }(Dt = _t || (_t = {}))[Dt.InvalidSafariSetup = 0] = "InvalidSafariSetup", Dt[Dt.Blocked = 1] = "Blocked", Dt[Dt.Dismissed = 2] = "Dismissed";
    ...
    class Ht {
        ...
        subscribe(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                switch (t) {
                    ...
                    case oe.a.OneSignalSubscriptionModal:
                    case oe.a.OneSignalSubscriptionPopup:
                        if ((yield OneSignal.privateGetNotificationPermission()) === A.Denied) throw new ge(le.Blocked);
        ...
        subscribeSafari() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                e.existingSafariDeviceToken = t, t || S.a.trigger(OneSignal.EVENTS.PERMISSION_PROMPT_DISPLAYED);
                const i = yield this.subscribeSafariPromptPermission();
                if (ue.a.triggerNotificationPermissionChanged(), !i) throw this.safariPermissionPromptFailed = !0, new Ft(_t.InvalidSafariSetup);
        ...
        subscribeFcmFromPage(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (y.a.getWindowEnv() !== oe.a.ServiceWorker && Notification.permission === A.Default) {
                    ...
                    const e = yield Ht.requestPresubscribeNotificationPermission(), t = e === A.Default;
                    switch (yield ue.a.triggerNotificationPermissionChanged(t), e) {
                        case A.Default:
                            throw E.a.debug("Exiting subscription and not registering worker because the permission was dismissed."), OneSignal._sessionInitAlreadyRunning = !1, OneSignal._isRegisteringForPush = !1, new ge(le.Dismissed);
                        case A.Denied:
                            throw E.a.debug("Exiting subscription and not registering worker because the permission was blocked."), OneSignal._sessionInitAlreadyRunning = !1, OneSignal._isRegisteringForPush = !1, new ge(le.Blocked)
                    }
                }
                try {
                    yield this.context.serviceWorkerManager.installWorker()
                } catch (e) {
                    throw e instanceof ct && (403 === e.status ? yield this.context.subscriptionManager.registerFailedSubscription(ie.ServiceWorkerStatus403, this.context): 404 === e.status && (yield this.context.subscriptionManager.registerFailedSubscription(ie.ServiceWorkerStatus404, this.context))), e
                }
                E.a.debug("[Subscription Manager] Getting OneSignal service Worker...");
                const t = yield this.context.serviceWorkerManager.getRegistration();
                if (!t) throw new Error("OneSignal service worker not found!");
                return E.a.debug("[Subscription Manager] Service worker is ready to continue subscribing."), yield this.subscribeWithVapidKey(t.pushManager, e)
            })
        }
        subscribeFcmFromWorker(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = self.registration;
                if (!t.active && !g.a.firefox) throw new m(o.ServiceWorkerNotActivated);
        ...
        subscribeWithVapidKey(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                switch (t) {
                    case 0:
                        if (!i) break;
                        i.options ? E.a.debug("[Subscription Manager] An existing push subscription exists and it's options is not null.") : (E.a.debug("[Subscription Manager] An existing push subscription exists and options is null. Unsubscribing from push first now."), yield Ht.doPushUnsubscribe(i));
                        break;
                    case 1:
                ...
                return i && (s.existingW3cPushSubscription = he.setFromW3cSubscription(i)), s
            })
        }
        static updateSubscriptionTime(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const i = yield M.a.getSubscription();
                e && (i.createdAt = (new Date).getTime()), i.expirationTime = t, yield M.a.setSubscription(i)
            })
        }
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                try {
                    ...
                    if ("InvalidStateError" == t.name) {
                        ...
                        return n && (yield Ht.doPushUnsubscribe(n)), [yield e.subscribe(i), !0]
                    }
                    throw t
                }
            })
        ...
        isSubscriptionExpiring() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const e = yield y.a.getIntegration(), t = y.a.getWindowEnv();
                switch (e) {
                    case Ne.a.Secure:
        ...
        isSubscriptionExpiringForSecureIntegration() {
            return Object(d.a)(this, void 0, void 0, function*() {
                if ((yield this.context.serviceWorkerManager.getActiveState()) !== kt.OneSignalWorker) return !1;
                const e = yield this.context.serviceWorkerManager.getRegistration();
                if (!e) return !1;
        ...
        getSubscriptionState() {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (h.a.useSafariLegacyPush()) return this.getSubscriptionStateForSecure();
        ...
        getSubscriptionStateForSecure() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const i = yield this.context.serviceWorkerManager.getActiveState(), n = yield this.context.serviceWorkerManager.getRegistration(), o = yield this.context.permissionManager.getNotificationPermission(this.context.appConfig.safariWebId), s = i === kt.OneSignalWorker;
                return n ? {
        ...
        getSubscriptionStateForInsecure() {
            return Object(d.a)(this, void 0, void 0, function*() {
                const {
                    ...
                    subscriptionToken: t,
                    optedOut: i
                } = yield M.a.getSubscription(), n = yield this.context.permissionManager.getNotificationPermission(this.context.appConfig.safariWebId);
                return {
        ...
        registerFailedSubscription(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                t.pageViewManager.isFirstPageView() && (t.subscriptionManager.registerSubscription(new he, e), t.pageViewManager.incrementPageViewCount())
            })
        }
    }
    var $t = class {
        static getServiceWorkerManager(e) {
            ...
            return t.userConfig && (t.userConfig.path && (n.workerPath = new st(`${t.userConfig.path}${t.userConfig.serviceWorkerPath}`)), t.userConfig.serviceWorkerParam && (n.registrationOptions = t.userConfig.serviceWorkerParam)), new Vt(e, n)
        }
    ...
    class Gt {
        ...
        sendPushDeviceRecordUpdate(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                e || (e = yield this.createDeviceRecord()), this.onSessionSent ? yield C.updatePlayer(this.context.appConfig.appId, t, Object.assign({
        ...
        sendOnSessionUpdate(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const t = yield this.getDeviceId();
                if (e || (e = yield this.createDeviceRecord()), e.subscriptionState === ie.Subscribed || !0 === OneSignal.config.enableOnSession) try {
                    this.context.sessionManager.upsertSession(t, e, me.b.PlayerOnSession), this.onSessionSent = !0
                } catch (e) {
        ...
        sendPlayerCreate(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                try {
                    ...
                    return t ? (E.a.info("Subscribed to web push and registered with OneSignal", e, t), this.onSessionSent = !0, this.context.sessionManager.upsertSession(t, e, me.b.PlayerCreate), t) : void E.a.error("Failed to create user.")
                } catch (e) {
        ...
        sendPushPlayerUpdate(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (t || (yield Object(X.d)(OneSignal.EVENTS.REGISTERED), ({
                        deviceId: t
                    } = yield M.a.getSubscription())), t) return yield C.updatePlayer(this.context.appConfig.appId, t, e)
            })
        }
    ...
    var Qt, Zt, Xt, ei;
    ! function(e) {
        e.Stylesheet = "https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.12/css/intlTelInput.min.css", e.Main = "https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.12/js/intlTelInput.min.js", e.Utils = "https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.12/js/utils.js"
    }(Qt || (Qt = {})),
    function(e) {
        e.Stylesheet = "sha512-yye/u0ehQsrVrfSd6biT17t39Rg9kNc+vENcCXZuMz2a+LWFGvXUnYuWUW6pbfYj1jcBb/C39UZw2ciQvwDDvg==", e.Main = "sha512-OnkjbJ4TwPpgSmjXACCb5J4cJwi880VRe+vWpPDlr8M38/L3slN5uUAeOeWU2jN+4vN0gImCXFGdJmc0wO4Mig==", e.Utils = "sha512-bUcJxlqkiGA3cmoYPuZaLRsyc5ChG9APG4ajom2AXKSlBtOmx4kLV3c8uv/6uSz43FMjI4Q2QI21+D223rT76w=="
    }(Zt || (Zt = {}));
    class ti {
        constructor(e) {
            this.smsInputFieldIsValid = !0, this.emailInputFieldIsValid = !0, this.promptOptions = e
        }
        generateHtml() {
            const e = document.createElement("div");
            let t, i, n;
            switch (Object(X.a)(e, Y.channelCaptureContainer), e.id = Y.channelCaptureContainer, this.promptOptions.type) {
                case T.Sms:
                    t = this.promptOptions.text.smsLabel || "Phone Number", i = this.getInputWithValidationElement(T.Sms, t), e.appendChild(i);
                    break;
                case T.Email:
                    t = this.promptOptions.text.emailLabel || "Email", n = this.getInputWithValidationElement(T.Email, t), e.appendChild(n);
                    break;
                case T.SmsAndEmail:
                    t = this.promptOptions.text.emailLabel || "Email", n = this.getInputWithValidationElement(T.Email, t), e.appendChild(n), t = this.promptOptions.text.smsLabel || "Phone Number", i = this.getInputWithValidationElement(T.Sms, t), e.appendChild(i)
            }
            return e
        }
        getValidationElementWithMessage(e) {
            ...
            return n.innerText = e, i.setAttribute("src", z), t.appendChild(i), t.appendChild(n), t
        }
        ...
        addSmsInputEventListeners() {
            ...
            e.addEventListener("keyup", t => {
                var i, n;
                this.smsInputFieldIsValid = this.itiOneSignal.isValidNumber() || "" === (null === (i = e) || void 0 === i ? void 0 : i.value), "Enter" === t.key && (null === (n = document.getElementById(V.allowButton)) || void 0 === n || n.click()), this.updateValidationOnSmsInputChange()
            }), e.addEventListener("blur", () => {
                var t;
                this.smsInputFieldIsValid = this.itiOneSignal.isValidNumber() || "" === (null === (t = e) || void 0 === t ? void 0 : t.value), this.updateValidationOnSmsInputChange()
            })
        }
        addEmailInputEventListeners() {
            ...
            e.addEventListener("keyup", t => {
                ...
                this.emailInputFieldIsValid = ti.validateEmailInputWithReturnVal(o), "Enter" === t.key && (null === (n = document.getElementById(V.allowButton)) || void 0 === n || n.click()), this.updateValidationOnEmailInputChange()
            })
        }
        updateValidationOnSmsInputChange() {
            ...
            Object(X.v)(e, Y.onesignalErrorInput), Object(X.a)(t, Y.onesignalValidationElementHidden)
        }
        ...
        loadPhoneLibraryScripts() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                e.src = Qt.Main, t.src = Qt.Utils, i.href = Qt.Stylesheet, i.rel = "stylesheet", e.integrity = Zt.Main, t.integrity = Zt.Utils, i.integrity = Zt.Stylesheet, e.crossOrigin = "anonymous", t.crossOrigin = "anonymous", i.crossOrigin = "anonymous", document.head.appendChild(e), document.head.appendChild(t), document.head.appendChild(i);
        ...
        mount() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                Object(X.l)(`#${V.body}`).appendChild(i), e && (this.initializePhoneInputLibrary(), this.addSmsInputEventListeners()), t && this.addEmailInputEventListeners()
            })
        }
        ...
        static showSmsInputError(e) {
            ...
            t && i ? e ? (t.classList.remove(Y.onesignalValidationElementHidden), i.classList.add(Y.onesignalErrorInput)) : (t.classList.add(Y.onesignalValidationElementHidden), i.classList.remove(Y.onesignalErrorInput)) : E.a.error("OneSignal: couldn't find slidedown validation element")
        }
    ...
    }(ei = Xt || (Xt = {}))[ei.InvalidSms = 0] = "InvalidSms", ei[ei.InvalidEmail = 1] = "InvalidEmail", ei[ei.InvalidEmailAndSms = 2] = "InvalidEmailAndSms";
    ...
    class ni {
        ...
        create(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (null === this.notificationIcons) {
                    ...
                    this.notificationIcons = t, this.container.className.includes(W.container) && Object(X.w)(`#${V.container}`);
                    const i = e && this.tagCategories ? this.positiveUpdateButton : this.options.text.acceptButton,
                        ...
                        o = function(e) {
                            ...
                            } = e, s = t === W.defaultIcon ? G : t, r = t === W.defaultIcon ? W.defaultIcon : "", a = document.createElement("div"), c = document.createElement("div"), l = document.createElement("div"), d = document.createElement("div"), u = document.createElement("div"), g = document.createElement("div"), h = document.createElement("button"), p = document.createElement("button"), m = document.createElement("div"), b = document.createElement("div"), f = document.createElement("img");
                            return Object(X.a)(c, W.body), Object(X.a)(d, W.icon), Object(X.a)(l, W.message), Object(X.a)(g, W.footer), Object(X.a)(m, W.clearfix), Object(X.a)(b, W.clearfix), Object(X.a)(h, F.alignRight), Object(X.a)(h, F.primary), Object(X.a)(h, F.slidedownButton), Object(X.a)(p, F.alignRight), Object(X.a)(p, F.secondary), Object(X.a)(p, F.slidedownButton), a.id = V.normalSlidedown, c.id = V.body, u.id = V.loadingContainer, h.id = V.allowButton, p.id = V.cancelButton, g.id = V.footer, r && Object(X.a)(f, r), f.setAttribute("alt", "notification icon"), f.setAttribute("src", s || ""), l.innerText = i || "", h.innerText = n || "", p.innerText = o || "", d.appendChild(f), c.appendChild(d), c.appendChild(l), c.appendChild(m), c.appendChild(u), g.appendChild(h), g.appendChild(p), g.appendChild(b), a.appendChild(c), a.appendChild(g), a
                        }({
                        ...
                        s = document.createElement("div"),
                        r = document.createElement("div");
                    s.id = V.container, Object(X.a)(s, W.container), Object(X.a)(s, W.reset), Object(X.l)("body").appendChild(s), r.id = V.dialog, Object(X.a)(r, W.dialog), r.appendChild(o), this.container.appendChild(r), Object(X.a)(this.container, g.a.mobile ? W.slideUp : W.slideDown), this.allowButton.addEventListener("click", this.onSlidedownAllowed.bind(this)), this.cancelButton.addEventListener("click", this.onSlidedownCanceled.bind(this))
                }
            })
        }
        ...
        onSlidedownCanceled(e) {
            ni.triggerSlidedownEvent(ni.EVENTS.CANCEL_CLICK), this.close(), ni.triggerSlidedownEvent(ni.EVENTS.CLOSED)
        }
        close() {
            Object(X.a)(this.container, W.closeSlidedown), Object(X.u)(this.dialog, "animationend", (e, t) => {
                e.target !== this.dialog || "slideDownExit" !== e.animationName && "slideUpExit" !== e.animationName || (Object(X.w)(`#${V.container}`), t())
            }, !0)
        }
        setSaveState() {
            this.allowButton.disabled = !0, this.allowButton.textContent = null, this.allowButton.insertAdjacentElement("beforeend", this.getTextSpan(this.savingButton)), this.allowButton.insertAdjacentElement("beforeend", this.getIndicatorHolder()), Object(X.b)(this.buttonIndicatorHolder, "beforeend", Jt(q.whiteLoadingIndicator)), Object(X.a)(this.allowButton, "disabled"), Object(X.a)(this.allowButton, W.savingStateButton)
        }
        removeSaveState() {
            this.allowButton.textContent = this.positiveUpdateButton, Object(X.w)(`#${W.buttonIndicatorHolder}`), this.allowButton.disabled = !1, Object(X.v)(this.allowButton, "disabled"), Object(X.v)(this.allowButton, W.savingStateButton)
        }
        setFailureState() {
            this.allowButton.textContent = null, this.allowButton.insertAdjacentElement("beforeend", this.getTextSpan(this.errorButton)), this.options.type === T.Category && (this.allowButton.insertAdjacentElement("beforeend", this.getIndicatorHolder()), Object(X.b)(this.buttonIndicatorHolder, "beforeend", function(e = "#FFFFFF") {
            ...
            }()), Object(X.a)(this.allowButton, "onesignal-error-state-button")), this.isShowingFailureState = !0
        }
        ...
        removeFailureState() {
            Object(X.w)("#onesignal-button-indicator-holder"), Object(X.v)(this.allowButton, "onesignal-error-state-button"), k.isSlidedownPushDependent(this.options.type) || ti.resetInputErrorStates(this.options.type), this.isShowingFailureState = !1
        }
        ...
        getIndicatorHolder() {
            const e = document.createElement("div");
            return e.id = V.buttonIndicatorHolder, Object(X.a)(e, W.buttonIndicatorHolder), e
        }
        getTextSpan(e) {
    ...
    class gi {
        constructor(e) {
            this.isNativePromptShowing = !1, this.context = e, this.eventHooksInstalled = !1
        }
        ...
        spawnAutoPrompts() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const i = OneSignal.config.userConfig.promptOptions,
                    ...
                    r = o.enabled && s,
                    a = n && r;
                if (r && !a) return void this.internalShowDelayedPrompt(T.Native, o.timeDelay || 0);
        ...
        internalShowDelayedPrompt(e, t, i) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (N.b.logMethodCall("internalShowDelayedPrompt"), "number" != typeof t) return void E.a.error("internalShowDelayedPrompt: timeDelay not a number");
                const {
                    requiresUserInteraction: n
                } = di.getEnvironmentInfo();
                switch (n && e === T.Native && (e = T.Push), t > 0 && (yield ui(1e3 * t)), e) {
                    case T.Native:
        ...
        internalShowNativePrompt() {
            return Object(d.a)(this, void 0, void 0, function*() {
                N.b.logMethodCall("internalShowNativePrompt"), this.isNativePromptShowing ? E.a.debug("Already showing autoprompt. Abort showing a native prompt.") : (this.isNativePromptShowing = !0, fe.markHttpSlidedownShown(), yield nt.registerForPushNotifications(), this.isNativePromptShowing = !1, Fe.markPromptDismissedWithType(Te.Push))
            })
        }
        internalShowSlidedownPrompt(e = {
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                N.b.logMethodCall("internalShowSlidedownPrompt"), e.slidedownPromptOptions || (e.slidedownPromptOptions = Yt), fe.markHttpSlidedownShown(), 0 === (yield this.context.dynamicResourceLoader.loadSdkStylesheet()) ? (this.eventHooksInstalled || this.installEventHooksForSlidedown(), yield this.context.slidedownManager.createSlidedown(e)) : E.a.debug("Not showing slidedown permission message because styles failed to load.")
            })
        }
        internalShowCategorySlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                N.b.logMethodCall("internalShowCategorySlidedown"), yield this.internalShowParticularSlidedown(T.Category, e)
            })
        }
        internalShowSmsSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                N.b.logMethodCall("internalShowSmsSlidedown"), yield this.internalShowParticularSlidedown(T.Sms, e)
            })
        }
        internalShowEmailSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                N.b.logMethodCall("internalShowEmailSlidedown"), yield this.internalShowParticularSlidedown(T.Email, e)
            })
        }
        internalShowSmsAndEmailSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                N.b.logMethodCall("internalShowSmsAndEmailSlidedown"), yield this.internalShowParticularSlidedown(T.SmsAndEmail, e)
            })
        }
        internalShowParticularSlidedown(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (!s) {
                    if (e !== T.Push) return void E.a.error(`OneSignal: slidedown of type '${e}' couldn't be shown. Check your configuration` + " on the OneSignal dashboard or your custom code initialization.");
        ...
        installEventHooksForSlidedown() {
            this.eventHooksInstalled = !0, OneSignal.emitter.on(ni.EVENTS.SHOWN, () => {
                this.context.slidedownManager.setIsSlidedownShowing(!0)
            }), OneSignal.emitter.on(ni.EVENTS.CLOSED, () => {
                this.context.slidedownManager.setIsSlidedownShowing(!1), this.context.slidedownManager.showQueued()
            }), OneSignal.emitter.on(ni.EVENTS.ALLOW_CLICK, () => Object(d.a)(this, void 0, void 0, function*() {
                yield this.context.slidedownManager.handleAllowClick(), S.a.trigger(OneSignal.EVENTS.TEST_FINISHED_ALLOW_CLICK_HANDLING)
                ...
                switch (e) {
                    case T.Push:
                    case T.Category:
                        E.a.debug("Setting flag to not show the slidedown to the user again."), Fe.markPromptDismissedWithType(Te.Push);
                        break;
                    default:
                        E.a.debug("Setting flag to not show the slidedown to the user again."), Fe.markPromptDismissedWithType(Te.NonPush)
                }
            })
        }
        ...
        getDelayedPromptOptions(e, t) {
            ...
            switch (t) {
                ...
                case T.SmsAndEmail:
                    const {
                        userConfig: c
                    } = this.context.appConfig, l = k.getFirstSlidedownPromptOptionsWithType((null === (n = null === (i = c.promptOptions) || void 0 === i ? void 0 : i.slidedown) || void 0 === n ? void 0 : n.prompts) || [], t);
                    return {
                        enabled: !!l,
    ...
    class hi {
        ...
        handleVisibilityChange() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if ("visible" === e) return this.setupOnFocusAndOnBlurForSession(), E.a.debug("handleVisibilityChange", "visible", `hasFocus: ${document.hasFocus()}`), void(document.hasFocus() && (yield this.notifySWToUpsertSession(t, i, me.b.VisibilityVisible)));
                if ("hidden" !== e) E.a.warn("Unhandled visibility state happened", e);
                else {
        ...
        handleOnBeforeUnload() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                e ? (E.a.debug("Notify SW to deactivate session (beforeunload)"), this.context.workerMessenger.directPostMessageToSW(Se.SessionDeactivate, t)) : (E.a.debug("Notify iframe to notify SW to deactivate session (beforeunload)"), yield OneSignal.proxyFrameHost.runCommand(OneSignal.POSTMAM_COMMANDS.SESSION_DEACTIVATE, t))
            })
        }
        handleOnFocus(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
        ...
        setupSessionEventListeners() {
            ...
            }, !0), OneSignal.cache.isBeforeUnloadEventSetup = !0)) : E.a.debug("Not setting session event listeners. Can't talk to ServiceWorker due being hosted on an HTTP page.") : E.a.debug("Not setting session event listeners. No service worker possible.")
        }
        ...
        sendOnSessionUpdateFromPage(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (e || (e = yield fe.createDeviceRecord(this.context.appConfig.appId)), e.subscriptionState === ie.Subscribed || !0 === OneSignal.config.enableOnSession) {
                    try {
    ...
    class mi {
        constructor(e) {
            this.tagsFromTaggingContainer = {}, this.remoteTags = {}, this.context = e
        }
        sendTags() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                return pi.isTagObjectEmpty(t) ? (E.a.warn("OneSignal: no change detected in Category preferences. Skipping tag update."), t) : yield OneSignal.sendTags(t)
            })
        }
    ...
    class bi {
        mount(e, t) {
            ...
            Object(X.l)(`#${V.body}`).appendChild(i), this.taggingContainer && this.taggingContainer.addEventListener("change", this.toggleCheckedTag);
            const n = Object(X.l)(`#${V.allowButton}`);
            n.disabled = !1, Object(X.v)(n, "disabled"), Object(X.w)(`#${V.loadingContainer}`)
        }
        load() {
            const e = Object(X.l)(`#${V.loadingContainer}`),
                t = Object(X.l)(`#${V.allowButton}`),
                i = document.createElement("div");
            Object(X.a)(e, `${W.loadingContainer}`), Object(X.a)(i, H.loadingMessage), Object(X.a)(t, "disabled"), Object(X.b)(e, "beforeend", Jt(q.greyLoadingIndicator)), i.innerText = K.fetchingPreferences, e.appendChild(i), t.disabled = !0
        }
        generateHtml(e, t) {
            ...
            return Object(X.a)(s, H.taggingContainerCol), Object(X.a)(r, H.taggingContainerCol), Object(X.a)(a, H.taggingContainer), a.id = $.taggingContainer, n.forEach(e => {
                s.appendChild(this.getCategoryLabelElement(e))
            }), o.forEach(e => {
                r.appendChild(this.getCategoryLabelElement(e))
            }), a.appendChild(s), a.appendChild(r), a
        }
        getCategoryLabelElement(e) {
            const {
                label: t
            } = e, i = document.createElement("label"), n = document.createElement("span"), o = document.createElement("input"), s = document.createElement("span"), r = document.createElement("div"), a = document.createElement("div");
            return Object(X.a)(i, H.categoryLabel), Object(X.a)(n, H.categoryLabelText), Object(X.a)(o, H.categoryLabelInput), Object(X.a)(s, H.checkmark), i.title = t, n.innerText = t, o.type = "checkbox", o.value = e.tag, o.checked = !!e.checked, i.appendChild(n), i.appendChild(o), i.appendChild(s), r.setAttribute("style", "clear:both"), a.appendChild(i), a.appendChild(r), a
        }
    ...
    class fi extends p.a {
        constructor(e) {
            super(`The permission message of type ${e||"unknown"} was previously dismissed.`), Object.setPrototypeOf(this, fi.prototype)
        }
    }
    class Si {
        constructor(e) {
        ...
        show() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                i.id = V.container, e.id = L.toastText, Object(X.a)(e, B.toastText), Object(X.a)(i, W.container), Object(X.a)(i, W.reset), Object(X.l)("body").appendChild(i), n.id = V.dialog, Object(X.a)(n, W.dialog), n.appendChild(e), this.container.appendChild(n), Object(X.a)(this.container, g.a.mobile ? W.slideUp : W.slideDown), Si.triggerSlidedownEvent(Si.EVENTS.SHOWN)
            })
        }
        static triggerSlidedownEvent(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
    ...
    class vi extends p.a {
        constructor() {
            super("This operation can only be performed when the user is not subscribed."), Object.setPrototypeOf(this, vi.prototype)
        }
    }
    class Oi extends p.a {
        constructor(e) {
            super(`This operation can only be performed when the channel '${e}' does not yet exist.`), Object.setPrototypeOf(this, Oi.prototype)
        }
    }
    class yi {
        constructor(e, t) {
            this.secondaryChannelManager = t, this.context = e, this.slidedownQueue = [], this.isSlidedownShowing = !1
        }
        checkIfSlidedownShouldBeShown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                var t;
                const i = (yield OneSignal.privateGetNotificationPermission()) === A.Denied,
                    n = yield OneSignal.privateIsPushNotificationsEnabled(), o = yield OneSignal.privateGetSubscription();
                let s;
                ...
                if (a && (c = k.isSlidedownPushDependent(a)), c) {
                    ...
                    if (s = Fe.wasPromptOfTypeDismissed(Te.Push), !o) throw new b(r.OptedOut);
                    ...
                    if (!e.force) {
                        ...
                        if (i && a === T.SmsAndEmail) return E.a.info(new Oi(T.SmsAndEmail)), !1
                    }
                    s = Fe.wasPromptOfTypeDismissed(Te.NonPush)
                }
                return !(s && !e.force && !e.isInUpdateMode) || (E.a.info(new fi(a)), !1)
            })
        }
        registerForPush() {
            const e = {
        ...
        handleAllowForCategoryType() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                this.context.tagManager.storeTagValuesToUpdate(e), U.getIsPushNotificationsEnabled() ? (OneSignal.slidedown.setSaveState(), yield this.context.tagManager.sendTags(!0)) : this.registerForPush()
            })
        }
        ...
        showConfirmationToast() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                yield ui(1e3);
                const t = new Si(e);
                yield t.show(), yield ui(5e3), t.close(), Si.triggerSlidedownEvent(Si.EVENTS.CLOSED)
            })
        }
            ...
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                try {
                    ...
                    if (e.isInUpdateMode) {
                        ...
                        this.context.tagManager.storeRemotePlayerTags(e), i = pi.convertTagsApiToBooleans(e)
        ...
        handleAllowClick() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                try {
                    ...
                    return E.a.warn("OneSignal Slidedown failed to update:", t), e.removeSaveState(), e.setFailureState(), void(void 0 !== t.reason && e.setFailureStateForInvalidChannelInput(t.reason))
                }
                switch (e && (e.close(), k.isSlidedownPushDependent(t) || (yield this.showConfirmationToast()), yield ui(1e3), ni.triggerSlidedownEvent(ni.EVENTS.CLOSED)), t) {
                    case T.Push:
                    case T.Category:
                        E.a.debug("Setting flag to not show the slidedown to the user again."), Fe.markPromptDismissedWithType(Te.Push);
                        break;
        ...
        createSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (function() {
                    ...
                    }(), this.isSlidedownShowing) this.enqueue(e);
                else try {
                    this.setIsSlidedownShowing(!0);
                    const t = e.slidedownPromptOptions || Yt;
                    OneSignal.slidedown = new ni(t), yield OneSignal.slidedown.create(e.isInUpdateMode), yield this.mountAuxiliaryContainers(e), E.a.debug("Showing OneSignal Slidedown"), ni.triggerSlidedownEvent(ni.EVENTS.SHOWN)
                } catch (e) {
                    E.a.error("There was an error showing the OneSignal Slidedown:", e), this.setIsSlidedownShowing(!1), OneSignal.slidedown.close()
                }
            })
        }
    }
    class wi {
        constructor(e) {
            this.appConfig = e, "undefined" != typeof OneSignal && OneSignal.environmentInfo && (this.environmentInfo = OneSignal.environmentInfo), this.secondaryChannelManager = new Bt, this.subscriptionManager = $t.getSubscriptionManager(this), this.serviceWorkerManager = $t.getServiceWorkerManager(this), this.pageViewManager = new ot, this.permissionManager = new j, this.workerMessenger = new Pe(this), this.updateManager = new Gt(this), this.sessionManager = new hi(this), this.tagManager = new mi(this), this.slidedownManager = new yi(this, this.secondaryChannelManager), this.promptsManager = new gi(this), this.dynamicResourceLoader = new Ce, this.metricsManager = new tt(e.metrics.enable, e.metrics.mixpanelReportingToken)
        }
    }! function(e) {
    ...
    class Ei {
        static upgradeConfigToVersionTwo(e) {
            var t, i, n;
            Ei.isPromptOptionsVersion0(e.promptOptions) && (e.promptOptions = Ei.convertConfigToVersionOne(e.promptOptions)), Ei.isSlidedownConfigVersion1(null === (t = e.promptOptions) || void 0 === t ? void 0 : t.slidedown) && (null === (i = e.promptOptions) || void 0 === i ? void 0 : i.slidedown) && (e.promptOptions.slidedown = Ei.convertConfigToVersionTwo(null === (n = e.promptOptions) || void 0 === n ? void 0 : n.slidedown))
        }
        ...
        static convertConfigToVersionTwo(e) {
            ...
            let r, a;
            return s === T.Category && (r = null === (t = e.categories) || void 0 === t ? void 0 : t.positiveUpdateButton, a = null === (i = e.categories) || void 0 === i ? void 0 : i.negativeUpdateButton), {
                prompts: [...e.prompts || [], {
                    type: s,
    ...
    }(ci = ai || (ai = {}))[ci.Dashboard = 0] = "Dashboard", ci[ci.JavaScript = 1] = "JavaScript";
    const Ii = 10;
    class Pi {
        static getAppConfig(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                try {
                    if (!e || !e.appId || !N.b.isValidUuid(e.appId)) throw new f(c.InvalidAppId);
        ...
        static checkRestrictedOrigin(e) {
            if (e.restrictedOriginEnabled && y.a.getWindowEnv() !== oe.a.ServiceWorker && window.top === window && !w.b.contains(window.location.hostname, ".os.tc") && !w.b.contains(window.location.hostname, ".onesignal.com") && !this.doesCurrentOriginMatchConfigOrigin(e.origin)) throw new f(c.WrongSiteUrl, {
                siteUrl: e.origin
            })
        }
        ...
        static injectDefaultsIntoPromptOptions(e, t, i, n = !1) {
            ...
            if (c.slidedown ? c.slidedown.prompts = null === (s = null === (o = c.slidedown) || void 0 === o ? void 0 : o.prompts) || void 0 === s ? void 0 : s.map(e => {
                    ...
                    if (e.type = w.b.getValueOrDefault(e.type, T.Push), e.type === T.Category && (e.text = Object.assign(Object.assign({}, e.text), {
                        ...
                        }), e.autoPrompt = w.b.getValueOrDefault(e.autoPrompt, !0), e.delay = {
                    ...
                    prompts: []
                }, c.slidedown.prompts = [Yt]), c.native ? (c.native.enabled = !!c.native.enabled, c.native.autoPrompt = c.native.hasOwnProperty("autoPrompt") ? !!c.native.enabled && !!c.native.autoPrompt : !!c.native.enabled, c.native.pageViews = w.b.getValueOrDefault(c.native.pageViews, qt.pageViews), c.native.timeDelay = w.b.getValueOrDefault(c.native.timeDelay, qt.timeDelay)) : c.native = {
                    enabled: !1,
                    autoPrompt: !1,
                    pageViews: qt.pageViews,
                    timeDelay: qt.timeDelay
            ...
            return c.autoPrompt = c.native.autoPrompt || k.isSlidedownAutoPromptConfigured(c.slidedown.prompts), c
        }
    ...
    class Ti {
        ...
        initialize() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                return OneSignal.environmentInfo = di.getEnvironmentInfo(), OneSignal.context = new wi(t), OneSignal.context.workerMessenger.listen(!0), OneSignal.initialized = !0, this.loadPromise = {}, this.loadPromise.promise = new Promise((e, t) => {
                    this.loadPromise.resolver = e, this.loadPromise.rejector = t
    ...
    class Ai extends Ti {
        ...
        onMessengerConnect(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return E.a.debug(`(${y.a.getWindowEnv().toString()}) Successfully established cross-origin communication.`), this.finishInitialization(), !1
            })
        }
        onProxyFrameInitializing(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (OneSignal.config = t, nt.installNativePromptPermissionChangedHook(), (yield M.a.get("Options", "defaultUrl")) || (yield M.a.put("Options", {
                        key: "defaultUrl",
                        value: new URL(OneSignal.config.pageUrl).origin
                    })), yield M.a.put("Options", {
                        key: "lastKnownHostUrl",
                        value: OneSignal.config.pageUrl
                    }), yield nt.initSaveState(), yield nt.storeInitialValues(), yield nt.saveInitOptions(), navigator.serviceWorker && "https:" === window.location.protocol) try {
        ...
        onUnsubscribeFromPush(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                try {
                    yield Object(X.z)(), e.reply(OneSignal.POSTMAM_COMMANDS.REMOTE_OPERATION_COMPLETE)
                } catch (e) {
        ...
        onMarkPromptDismissed(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return E.a.debug("(Reposted from iFrame -> Host) Marking prompt as dismissed."), yield Fe.markPromptDismissedWithType(Te.Push), e.reply(OneSignal.POSTMAM_COMMANDS.REMOTE_OPERATION_COMPLETE), !1
            })
        }
        onIsSubscribed(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
        ...
        onSessionUpsert(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = OneSignal.context,
                    i = e.data;
                t.workerMessenger.directPostMessageToSW(Se.SessionUpsert, i), e.reply(!0)
            })
        }
        onSessionDeactivate(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = OneSignal.context,
                    i = e.data;
                t.workerMessenger.directPostMessageToSW(Se.SessionDeactivate, i), e.reply(!0)
            })
        }
        ...
        onAreYouVisibleResponse(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const t = OneSignal.context,
                    i = e.data;
                t.workerMessenger.directPostMessageToSW(Se.AreYouVisibleResponse, i), e.reply(!0)
            })
        }
    }
    class Mi extends Ti {
        ...
        establishCrossOriginMessaging() {
            this.messenger && this.messenger.destroy(), this.messenger = new ye(window.parent, this.options.origin, this.options.origin)
        }
    }
    class Ni extends Ti {
        constructor(e) {
        ...
        establishCrossOriginMessaging() {
            this.messenger = new ye(window.opener, this.options.origin, this.options.origin), this.messenger.once(OneSignal.POSTMAM_COMMANDS.CONNECTED, this.onMessengerConnected.bind(this)), this.messenger.postMessage(OneSignal.POSTMAM_COMMANDS.POPUP_BEGIN_MESSAGEPORT_COMMS, null), this.messenger.listen()
        }
        onMessengerConnected(e) {
            E.a.debug(`(${y.a.getWindowEnv().toString()}) The host page is now ready to receive commands from the HTTP popup.`), this.finishInitialization()
        }
    }
    class xi {
        static initHttp(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                switch (E.a.debug(`Called %cinitHttp(${JSON.stringify(e,null,4)})`, Object(X.k)("code")), y.a.getWindowEnv()) {
                    case oe.a.OneSignalProxyFrame:
                        OneSignal.proxyFrame = new Ai(e), yield OneSignal.proxyFrame.initialize(), se.ensureBackwardsCompatibility(OneSignal);
                        break;
                    case oe.a.OneSignalSubscriptionPopup:
                        OneSignal.subscriptionPopup = new Ni(e), yield OneSignal.subscriptionPopup.initialize(), se.ensureBackwardsCompatibility(OneSignal), S.a.trigger("httpInitialize");
                        break;
                    case oe.a.OneSignalSubscriptionModal:
                        OneSignal.subscriptionModal = new Mi(e), OneSignal.subscriptionModal.establishCrossOriginMessaging(), OneSignal.subscriptionModal.initialize(), se.ensureBackwardsCompatibility(OneSignal), S.a.trigger("httpInitialize");
                        break;
                    default:
        ...
        load() {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                return e.style.display = "none", e.src = this.url.toString(), e.sandbox = "allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation", this.loadPromise = {}, this.loadPromise.promise = new Promise((e, t) => {
                    this.loadPromise.resolver = e, this.loadPromise.rejector = t
                }), document.body.appendChild(e), e.onload = this.onFrameLoad.bind(this), this.element = e, Object(X.x)(this.loadPromise.promise, ji.LOAD_TIMEOUT_MS).catch(() => {
    ...
    class _i {
        ...
        static discoverAltOrigin(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                let o;
                yield _i.removeDuplicatedAltOriginSubscription(n), o = 0 === n.length ? i[0] : n[0];
    ...
    class Ui {
        static processItem(e, t) {
            if ("function" == typeof t) t();
                ...
                if (!Array.isArray(t)) throw new p.a("Only accepts function and Array types!"); {
                    if (0 == t.length) throw new p.a("Empty array is not valid!");
                    const i = t.shift();
                    if (null == i || void 0 === i) throw new p.a("First element in array must be the OneSignal function name");
                    const n = e[i.toString()];
                    if ("function" != typeof n) throw new p.a(`No OneSignal function with the name '${i}'`);
                    n.apply(e, t)
                }
            }
        }
    ...
    class Wi {
        static throwIfInvalidAuthHashOptions(e, t) {
            ...
            if (i.length > 1) throw E.a.error("More than one key provided, please only provide one!", i), new InvalidArgumentError.a("options", InvalidArgumentError.b.Malformed);
            const n = i[0],
                o = e[n];
            return o ? (Wi.throwIfInvalidAuthHash(o, `options.${n}`), o) : void 0
        }
        static throwIfInvalidAuthHash(e, t) {
            if (e && e.length !== Wi.VALID_AUTH_HASH_LENGTH) throw new InvalidArgumentError.a(t, InvalidArgumentError.b.Malformed)
        }
    }
    Wi.VALID_AUTH_HASH_LENGTH = 64, i.d(t, "default", function() {
        return Bi
    });
    class Bi {
        ...
        static setEmail(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (!Object(X.r)(e)) throw new InvalidArgumentError.a("email", InvalidArgumentError.b.Malformed);
                const i = Wi.throwIfInvalidAuthHashOptions(t, ["identifierAuthHash", "emailAuthHash"]);
                return Object(X.s)("setEmail", e, t), yield Object(X.c)(), yield this.context.secondaryChannelManager.email.setIdentifier(e, i)
            })
        }
        static setSMSNumber(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (!e) throw new InvalidArgumentError.a("smsNumber", InvalidArgumentError.b.Empty);
                const i = Wi.throwIfInvalidAuthHashOptions(t, ["identifierAuthHash"]);
                return Object(X.s)("setSMSNumber", e, t), yield Object(X.c)(), yield this.context.secondaryChannelManager.sms.setIdentifier(e, i)
            })
        }
        static logoutEmail() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(X.c)(), yield this.context.secondaryChannelManager.email.logout()
            })
        }
        static logoutSMS() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(X.c)(), yield this.context.secondaryChannelManager.sms.logout()
            })
        }
        ...
        static initializeConfig(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                const t = yield(new Ci).getAppConfig(e);
                E.a.debug(`OneSignal: Final web app config: %c${JSON.stringify(t,null,4)}`, Object(X.k)("code")), Bi.config = t, Bi.environmentInfo = di.getEnvironmentInfo(), Bi.context = new wi(t), Bi.config = Bi.context.appConfig
            })
        }
        static init(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (Object(X.s)("init"), yield nt.polyfillSafariFetch(), nt.errorIfInitAlreadyCalled(), yield Bi.initializeConfig(e), !Bi.config) throw new Error("OneSignal config not initialized!");
                if (!g.a.safari || Bi.config.safariWebId) {
                    if (Bi.config.userConfig.requiresUserPrivacyConsent) {
                        if (!(yield M.a.getProvideUserConsent())) return void(Bi.pendingInit = !0)
                    }
                ...
                function e() {
                    return Object(d.a)(this, void 0, void 0, function*() {
                        if (!Bi.__initAlreadyCalled) {
                            if (Bi.__initAlreadyCalled = !0, Bi.emitter.on(Bi.EVENTS.NATIVE_PROMPT_PERMISSIONCHANGED, te.onNotificationPermissionChange), Bi.emitter.on(Bi.EVENTS.SUBSCRIPTION_CHANGED, te._onSubscriptionChanged), Bi.emitter.on(Bi.EVENTS.SDK_INITIALIZED, nt.onSdkInitialized), N.b.isUsingSubscriptionWorkaround()) {
                                if (!Bi.config || !Bi.config.subdomain) throw new f(c.MissingSubdomain);
                                Bi.emitter.on(Bi.EVENTS.SESSION_STARTED, hi.setupSessionEventListenersForHttp), Bi.proxyFrameHost = yield _i.discoverAltOrigin(Bi.config)
                            }
                            window.addEventListener("focus", () => {
                                fe.checkAndTriggerNotificationPermissionChanged()
                            }), yield nt.initSaveState(), yield nt.saveInitOptions(), y.a.getWindowEnv() === oe.a.CustomIframe ? yield S.a.trigger(Bi.EVENTS.SDK_INITIALIZED): yield nt.internalInit()
                        }
                    })
                }
                Bi.pendingInit = !1, Bi.context.workerMessenger.listen(), "complete" === document.readyState || "interactive" === document.readyState ? yield e(): (E.a.debug("OneSignal: Waiting for DOMContentLoaded or readyStateChange event before continuing initialization..."), window.addEventListener("DOMContentLoaded", () => {
                    e()
        ...
        static provideUserConsent(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield M.a.setProvideUserConsent(e), e && Bi.pendingInit && (yield Bi.delayedInit())
            })
        }
        static showHttpPermissionRequest(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                E.a.debug("Called showHttpPermissionRequest(), redirecting to HTTP prompt."), Bi.showHttpPrompt(e).catch(e => E.a.info(e))
            })
        }
        ...
        static showNativePrompt() {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(X.c)(), yield Bi.context.promptsManager.internalShowNativePrompt()
            })
        }
        static showSlidedownPrompt(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(X.c)(), yield Bi.context.promptsManager.internalShowParticularSlidedown(T.Push, e)
            })
        }
        ...
        static showSmsSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(X.c)(), yield Bi.context.promptsManager.internalShowSmsSlidedown(Object.assign({}, e))
            })
        }
        static showEmailSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(X.c)(), yield Bi.context.promptsManager.internalShowEmailSlidedown(Object.assign({}, e))
            })
        }
        static showSmsAndEmailSlidedown(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(X.c)(), yield Bi.context.promptsManager.internalShowSmsAndEmailSlidedown(Object.assign({}, e))
            })
        }
        static registerForPushNotifications(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
        ...
        static sendTags(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(X.c)(), Object(X.s)("sendTags", e, t), e && 0 !== Object.keys(e).length ? (Object.keys(e).forEach(t => {
                    !1 === e[t] && (e[t] = "false")
                }), yield this.context.updateManager.sendTagsUpdate(e), Object(X.j)(t, e), e) : (E.a.info(new InvalidArgumentError.a("tags", InvalidArgumentError.b.Empty)), null)
            })
        }
        static deleteTag(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
        ...
        static deleteTags(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (yield Object(X.c)(), Object(X.s)("deleteTags", e, t), !Ri.isValidArray(e)) throw new InvalidArgumentError.a("tags", InvalidArgumentError.b.Malformed);
        ...
        static setExternalUserId(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(X.c)(), Object(X.s)("setExternalUserId"), yield Bi.privateSetExternalUserId(e, t)
            })
        }
        static privateSetExternalUserId(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                Wi.throwIfInvalidAuthHash(t, "authHash"), yield Bi.database.setExternalUserId(e, t), yield Bi.context.updateManager.sendExternalUserIdUpdate(e, t)
            })
        }
        static getExternalUserId() {
            return Object(d.a)(this, void 0, void 0, function*() {
                return yield Object(X.c)(), Object(X.s)("getExternalUserId"), yield Bi.database.getExternalUserId()
            })
        }
        static removeExternalUserId() {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(X.c)(), Object(X.s)("removeExternalUserId"), yield Bi.privateSetExternalUserId(void 0)
            })
        }
        static addListenerForNotificationOpened(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(X.c)(), Object(X.s)("addListenerForNotificationOpened", e), Bi.emitter.once(Bi.EVENTS.NOTIFICATION_CLICKED, t => {
                    Object(X.j)(e, t)
        ...
        static privateIsPushNotificationsEnabled(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                return Object(X.j)(e, t.subscribed && !t.optedOut), t.subscribed && !t.optedOut
            })
        }
        static setSubscription(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                const t = yield M.a.getAppConfig(), {
                    appId: i
                } = t, n = yield M.a.getSubscription(), {
                    deviceId: s
                } = n;
                if (!t.appId) throw new m(o.MissingAppId);
                if (!Ri.isValidBoolean(e)) throw new InvalidArgumentError.a("newSubscription", InvalidArgumentError.b.Malformed);
                ...
                c && (a.external_user_id_auth_hash = c), n.optedOut = !e, yield yt.updatePlayer(i, s, a), yield M.a.setSubscription(n), te.onInternalSubscriptionSet(n.optedOut), te.checkAndTriggerSubscriptionChanged()
            })
        }
        static isOptedOut(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
        ...
        static optOut(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                if (yield Object(X.c)(), Object(X.s)("optOut", e, t), !Ri.isValidBoolean(e)) throw new InvalidArgumentError.a("doOptOut", InvalidArgumentError.b.Malformed);
        ...
        static sendSelfNotification(e = "OneSignal Test Message", t = "This is an example notification.", i = `${new URL(location.href).origin}?_osp=do_not_open`, n, s, a) {
            return Object(d.a)(this, void 0, void 0, function*() {
                yield Object(X.c)(), Object(X.s)("sendSelfNotification", e, t, i, n, s, a);
                const c = yield M.a.getAppConfig(), l = yield M.a.getSubscription();
                if (!c.appId) throw new m(o.MissingAppId);
                if (!(yield Bi.isPushNotificationsEnabled())) throw new b(r.NoDeviceId);
                if (!Ri.isValidUrl(i)) throw new InvalidArgumentError.a("url", InvalidArgumentError.b.Malformed);
                if (!Ri.isValidUrl(n, {
                        allowEmpty: !0,
                        requireHttps: !0
        ...
        static sendOutcome(e, t) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (!i) return void E.a.error(`Could not send ${e}. No outcomes config found.`);
        ...
        static sendUniqueOutcome(e) {
            return Object(d.a)(this, void 0, void 0, function*() {
                ...
                if (!t) return void E.a.error(`Could not send ${e}. No outcomes config found.`);
                const i = new pt(Bi.config.appId, t, e, !0);
                if (!(yield i.beforeOutcomeSend())) return;
                const n = yield i.getAttribution();
                if (n.type === at.NotSupported) return void E.a.warn("You are on a free plan. Please upgrade to use this functionality.");
                const {
                    notificationIds: o
                } = n, s = yield i.getNotifsToAttributeWithUniqueOutcome(o);
    ...
    Bi.VERSION = h.a.version(), Bi._VERSION = h.a.version(), Bi.sdkEnvironment = y.a, Bi._notificationOpenedCallbacks = [], Bi._idsAvailable_callback = [], Bi._defaultLaunchURL = null, Bi.config = null, Bi._sessionInitAlreadyRunning = !1, Bi._isNotificationEnabledCallback = [], Bi._subscriptionSet = !0, Bi.modalUrl = null, Bi._windowWidth = 650, Bi._windowHeight = 568, Bi._isNewVisitor = !1, Bi._channel = null, Bi.timedLocalStorage = Be, Bi.initialized = !1, Bi._didLoadITILibrary = !1, Bi.notifyButton = null, Bi.store = v, Bi.environment = h.a, Bi.database = M.a, Bi.event = S.a, Bi.browser = g.a, Bi.slidedown = null, Bi.log = E.a, Bi.api = yt, Bi.indexedDb = Di.a, Bi.mainHelper = fe, Bi.subscriptionHelper = be, Bi.httpHelper = xi, Bi.eventHelper = te, Bi.initHelper = nt, Bi.pendingInit = !0, Bi.emitter = new Oe.a, Bi.cache = {}, Bi.SERVICE_WORKER_PATH = "OneSignalSDKWorker.js", Bi.SERVICE_WORKER_PARAM = {
        scope: "/"
    }, Bi._LOGGING = !1, Bi.LOGGING = !1, Bi._initCalled = !1, Bi.__initAlreadyCalled = !1, Bi.checkAndWipeUserSubscription = function() {}, Bi.DeviceRecord = ae, Bi.SecondaryChannelDeviceRecord = It, Bi.notificationPermission = A, Bi._initHttp = xi.initHttp, Bi._initPopup = (() => Bi.subscriptionPopup.subscribe()), Bi.POSTMAM_COMMANDS = {
        CONNECTED: "connect",
    ...
    }, se.ensureBackwardsCompatibility(Bi), E.a.info(`%cOneSignal Web SDK loaded (version ${Bi._VERSION},\n  ${y.a.getWindowEnv().toString()} environment).`, Object(X.k)("bold")), E.a.debug(`Current Page URL: ${"undefined"==typeof location?"NodeJS":location.href}`), E.a.debug(`Browser Environment: ${g.a.name} ${g.a.version}`)
}, function(e, t) {
    var i;
    i = function() {
        return this
